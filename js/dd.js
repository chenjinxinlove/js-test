function addEV(t, e, n) {
    window.attachEvent
        ...
        : window.addEventListener && t.addEventListener(e, n, !1)
}
function _aMC(t) {
    for (var e = t, n = -1; e = e.parentNode;) 
        if (n = parseInt(e.getAttribute("id")), n > 0) 
            return n
}
function al_c(t) {
    for (; "TABLE" != t.tagName;) 
...
function c(t) {
    var e = t.p1;
    if (!("alop" != t.fm || "rsv_xpath" in t || e && "6677" == G(e).getAttribute("srcid"))) 
        return !0;
    ...
    if (window.bds && bds.comm) {
        ...
        if (bds.comm.inter && (c = c + "&rsv_inter=" + bds.comm.inter), bds.comm.seinfo && bds.comm.seinfo.rsv_pstg && (c = c + "&rsv_pstg=" + bds.comm.seinfo.rsv_pstg), bds.comm.cftime && 0 != bds.comm.cftime && (c = c + "&rsv_cftime=" + bds.comm.cftime), c += bds.comm.resultPage
            ? "&rsv_iorr=1"
            : "&rsv_iorr=0", bds.comm.tn && (c = c + "&rsv_tn=" + bds.comm.tn), bds.comm.indexSid && (c += "&rsv_isid=" + bds.comm.indexSid), bds.comm.lastVoiceQuery && (c += "&rsv_lavo=" + encodeURIComponent(bds.comm.lastVoiceQuery)), Cookie.get("ispeed") && (c += "&rsv_ispeed=" + Cookie.get("ispeed")), /ssl_sample/.test(location.href)) {
            var d = location
                .href
                .match(/ssl_sample=[^=&]+/i);
            c += "&rsv_" + d[0]
        ...
        c += "&rsv_ssl=" + ("https:" === location.protocol
            ? 1
            : 0),
        c += "&path=" + encodeURIComponent(n),
        c += "&rsv_did=" + (bds.comm.did
            ? bds.comm.did
            : ""),
        s.src = c
    }
...
function ns_c_pj(t, e) {
    var n = encodeURIComponent(window.document.location.href),
        ...
        i = "",
        r = "",
        s = bds && bds.comm && bds.comm.did
            ? bds.comm.did
            : "";
    wd = bds.comm.queryEnc,
    nsclickDomain = bds && bds.util && bds.util.domain
        ? bds
            .util
            .domain
            .get("http://nsclick.baidu.com")
    ...
    if (r = "&mu=" + n, src = nsclickDomain + "/v.gif?pid=201&" + (e || "") + o + "path=" + n + "&wd=" + wd + "&rsv_sid=" + (bds.comm.ishome && bds.comm.indexSid
        ? bds.comm.indexSid
        : bds.comm.sid) + "&rsv_did=" + s + "&t=" + (new Date).getTime(), "undefined" != typeof Cookie && "undefined" != typeof Cookie.get) 
        Cookie.get("H_PS_SKIN") && "0" != Cookie.get("H_PS_SKIN") && (src += "&rsv_skin=1");
    else {
        var a = "";
        try {
...
function initPreload(t) {
    ...
    function o(t) {
        ...
        t && t.length && $.each(t, function (t, e) {
    ...
    function a(t) {
        function e(t) {
            if (document.all) 
                $("style[data-for='result']").get(0).styleSheet.cssText += t;
            else {
        ...
        function n() {
            B.css({filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=95)", opacity: .95}),
            F || (e(".slowmsg{z-index:301;background-color:#fff;border:1px solid #f0f0f0;position:fix" +
                    "ed;_position:absolute;top:144px;left:212px;height:95px;width:360px;box-shadow:0 " +
                    "0 5px rgba(0,0,0,0.05)}.slowmsg .ball{width:40px;margin:41px auto 0;position:rel" +
                    "ative;}.slowmsg .b{left:20px;position:absolute;width:10px;height:10px;-moz-borde" +
                    "r-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;}"), F = $('<div class="slowmsg"><div class="ball"><div class="b"/><div class="b"/><div clas' +
                    's="b"/></div></div>'), F.find(".b").each(function (t, e) {
                var n = [
                        [
                            0, 40
                        ],
                    ...
                    o = [
                        "rgb(55,137,250)", "rgb(99,99,99)", "rgb(235,67,70)"
                    ],
                    i = 0;
                $(e).css({"background-color": o[t]}),
                function r() {
                    return H
                        ? ($(e).animate({
                            left: n[i % 2]
    ...
    function p(t, e) {
        ...
        if (!p.__init) {
            ...
            var i = "";
                e.wd = $.limitWd(e.wd);
                for (param in e) 
                    param && e.hasOwnProperty(param) && "" !== e[param] && (i += param + "=" + encodeURIComponent(e[param]).replace(/'/g, "%27") + "&");
            ...
            p.prototype.filterOtherParams = function () {
                for (var t in this.params) 
                    this.params.hasOwnProperty(t) && l(i, t) < 0 && delete this.params[t]
            },
            p.prototype.wdSameName = function () {
                var t;
                for (t = 0; t < r.length; t++) 
                    this.params && this.params[r[t]] && (this.params.wd = this.params[r[t]], delete this.params[r[t]])
            }
        }
        if (this.params = {}, !e) {
            je = we.serializeArray();
            for (var s = 0; s < je.length; s++) 
                this.p(je[s].name) || this.p(je[s].name, je[s].value)
        }
        if ("object" == typeof t) 
            for (var a in t) 
                t.hasOwnProperty(a) && this.p(a, t[a]);
    this.wdSameName()
    }
    function f(t) {
        function e(t) {
            "string" == typeof t && (_[t] = Date.now
                ? Date.now() :+ new Date)
        }
        function n(t, e) {
        ...
        function o() {
            w.cus_net = _.net > _.st && _.net - _.st - w.cus_srv > 0
                ? _.net - _.st - w.cus_srv
                : 1,
            w.cus_tti2 = _.dom > _.st
                ? _.dom - _.st
                : 1,
        ...
        function i(t) {
            var e = "";
            for (var n in t) 
                n && t.hasOwnProperty(n) && "" !== t[n] && (e += "&" + n + "=" + encodeURIComponent(t[n]));
            return e
        }
        function r(t) {
            var t = [];
            ...
            t
                ...
                .one("load", function () {
                    ...
                    if (I > o && o > 0) {
                        ...
                        var s = _.fs - _.dom;
                        y.push(o + "_" + i + "_" + s),
                        r = $(this).attr("data-src") || /^http/.test($(this).attr("src"))
        ...
        function f() {
            var t,
                e,
                n = $.parseJSON(bds.comm.speedInfo),
                o = [];
            for (var i in n) {
                if (t = n[i], e = t.ModuleId + "_" + t.TimeCost + "_" + t.TimeSelf + "_" + t.Idc, t.hasOwnProperty("SubProcess")) 
                    for (var r in t.SubProcess) 
                        e += "," + t.SubProcess[r].ProcessId + "_" + t.SubProcess[r].TimeCost + "_" + t.SubProcess[r].isHitCache + "_" + t.SubProcess[r].Idc;
            o.push(e)
            }
            return encodeURIComponent(o.join("|"))
        }
        function h(t) {
            for (var e = 0, o = t.find("img"), i = t.find("#content_left").find("img"), r = 0, s = 0, a = 0; a < o.length; a++) 
                s = o.eq(a).offset().top,
                I > s && s > 0 && e++;
            n("cus_ic", o.length),
            n("cus_extic", e),
        ...
        if (bds.comm.seinfo) {
            ...
            if (bds && bds.comm && bds.comm.personalData) 
                try {
                    ...
                    t = bds.comm.personalData
                        ? bds.comm.personalData.fullSkinName && bds.comm.personalData.fullSkinName.value
                        : null
                } catch (e) {
                    t = null
                }
            if (t && (bds.comm.seinfo.rsv_skin = t), bds.comm.seinfo.rsv_psid = $.getCookie("BIDUPSID"), bds.comm.seinfo.rsv_pstm = $.getCookie("PSTM"), bds.comm.seinfo.rsv_idc = function () {
                ...
                for (var n = 0, o = t.length; o > n; n++) 
                    if (9540 == t[n].ModuleId) 
                        return t[n].Idc || "";
            return ""
            }(),
            c(bds.comm.seinfo),
            "ON" === bds.comm._se_click_track_flag) {
                var n = new Image,
    ...
    function w(t, e) {
        ...
        if (i && (n = i.match(/^\/*(link|baidu.php)\?(.*)$/), n = i.match(e.regex)), !(n && n[2] && n[2].match(/&(wd|word)=/))) {
            if (i && n) {
                ...
                var s = ie.getLinkParams(i);
                s && ("https:" === ne.protocol && /Chrome|Safari/.test(navigator.userAgent) && (o = o.replace(/^http:\/\/www\.baidu\.com/, "https://www.baidu.com")), i = o + "/" + n[1] + "?" + n[2] + "&" + s, t.attr("href", o + "/" + n[1] + "?" + n[2] + "&" + s), t.click(function () {
                    window
                        .PDC_ASYNC
                        .setLinkData("click_t", (new Date).getTime()),
                    window
                        .PDC_ASYNC
                        .setLinkData("linkpreload", $(this).attr("linkpreload"))
                }))
            }
            return i
        }
    ...
    function _(t) {
        if (!window.__disable_is2 || $.trim(t) != $.trim($e.val())) {
            if (Ze || !bds.comm.supportis) 
                return void(Te && Te.html(""));
            if (0 != pageState && !window.__disable_kw_tip) 
                if (Te || (Te = $('<div id="kw_tip" style="width:initial" unselectable="on" onselectstart="return f' +
                        'alse;" class="s_ipt_tip"/>').insertBefore($e), Te.parent().click(function (t) {
                    var e = $e.get(0);
                    if (t.target === e) 
                        return !0;
                    e.focus();
                    ...
                    if (document.selection) {
                        ...
                        "number" == typeof e.selectionStart && "number" == typeof e.selectionEnd && (e.selectionStart = e.selectionEnd = n);
                    return !1
    ...
    function k(t, e) {
        ...
        if (J.use_cache_repeatedly && (i = i.clone()), m(function () {
            ...
            var r = Pe.buildSyncSearchUrl({
                jmp: "jsver",
                _vr: Math.random()
            });
            return void ne.replace(r)
        }
        m(function () {
            i
                .find("#content_script script")
                .each(function (t, e) {
                    $.globalEval($(e).html())
                })
        }),
            ...
            if (o.size()) 
                if (t.children().size()) {
                    var r = t
                        .children()
                        .children();
                    o.attr("cq") != r.attr("cq") || o.attr("srcid") != r.attr("srcid") || e.force && oldEnv && oldEnv.equals(Pe) || !Pe.p("cq") || !Pe.p("srcid") || 1 == Pe.p("_trf")
                        ? (n.remove(), $(window).trigger("top_result_removed"), u(Ae, t, "insertBefore"))
                        : s = !0
                } else 
                    n.remove(),
        ...
        bds && bds.comm && bds.comm.templateName == bds.comm.resTemplateName
            ? bds.comm.seinfo && (bds.comm.seinfo.rsv_tpfail = 0)
            : bds.comm.seinfo && (bds.comm.seinfo.rsv_tpfail = 1),
        0 != pageState && bds && bds.util && bds.util.setContainerWidth && bds
            .util
            .setContainerWidth(),
    ...
    function S() {
        ...
        m(function () {
            window.app && window.app.dispose && window
                .app
                .dispose()
        }),
        m(function () {
            bds
                .comm
                .resolveUnloadHandler()
        }),
        bds && bds.se && bds.se.certification && bds.se.certification.data && (bds.se.certification.data = []),
        bds && bds.se && bds.se.userAction && bds
            .se
            .userAction
            .destroy()
    }
    ...
    function D(t, e, n) {
        return function (e) {
            ...
            if (t && !t.confirm) {
                ...
                i.is_referer = oe,
                i.is_xhr = "1";
                var r = new p(s(ie.getQueryString()), !0);
                t
                    .env
                    .equals(r) || t
                    .env
                    .clone({wd: t.prw})
                    .equals(r) || ie.setUrl(t.env),
                ...
                var a = "/s?ie=utf-8&csq=" + t.seq + "&pstg=" + n + (o.tipConfirm
                    ? "&_cktip=1"
                    : "") + "&mod=2" + (bds.comm.supportis
                    ? "&isbd=1"
                    : "") + "&cqid=" + t.qid + "&istc=" + ((new Date).getTime() - t.startTime) + "&ver=" + bds.comm.baiduis_verify + "&chk=" + t.chk + "&isid=" + ve + "&" + t
                    .env
                    .buildQueryString() + (t.force
                    ? "&f4s=1"
                    : "") + ("function" == typeof Ke
                    ? "&_ck=" + Ke(t.env.p("wd"))
                    : "");
                if (bds.comm.indexSid && (/9998_/.test(bds.comm.indexSid) && "https:" === ne.protocol && (bds.comm.indexSid = bds.comm.indexSid.replace("9998", "8499")), a += "&rsv_isid=" + bds.comm.indexSid), t.no_predict && (a += "&isnop=" + (1 >= fe
                    ? 0
                    : 1)), t && t.pstg && (a += "&isctg=" + t.pstg), fe = 0, Ue && Ue.getRsvStatus) 
                    try {
                ...
                if (He.done(function () {
                ...
                }), $.ajax({headers: i, url: a}).done(function (t) {
                    ...
                    bds.comm.seinfo.rsv_svoice = window.__supportvoice
                        ? "1"
                        : "0",
                    t.cftime += 1,
                ...
                He.done(function () {
                    20 == n
                        ? Ue.updateInitData()
                        : 22 == n || bds.comm.supportis || n >= 0 && 5 >= n && Ue.updateInitData(),
                    Ue.clearStat()
                }),
                window
                    .cfpromise
    ...
    function R(t) {
        ...
        if (nn) 
            return !1;
        if (nn = !0, $e.blur(), _(""), $(this).attr("target")) 
            return !0;
        en = !0,
        ...
        try {
            ...
            for (e = 0; e < o.length; e++) 
                n.p(o[e].name, o[e].value);
            if (n.p("wd", $e.val()), n.p("nojc") && n.p("nojc", ""), ze) {
                if (n.equals(ze.env.clone({wd: ze.real_wd})) && !ze.force) 
                    return D(ze, Fe, 22)(),
                    ze.force = !0,
                    _(""),
                    T(ze),
                ...
                ze
                    .env
                    .p("rsv_spt") && n.p("rsv_spt", ze.env.p("rsv_spt"))
            }
            ie.submit(n, !!t)
        } catch (i) {}
        return !1
    ...
    function A(t) {
        ...
        var n,
            ...
            s = e.shouldShow,
            c = e.use_cache;
        if (o && o.p("wd") && o.hashCode() && (!re && 1 != Cookie.get("ISSW") || i || !r) && (!ae && 1 != Cookie.get("ISSW") || i || r)) {
            if (c && (n = ee.hasCache(o, {
                loaded: !0
            }))) 
                return void(s && (ze && n.env.clone({wd: n.real_wd}).equals(ze.env.clone({wd: ze.real_wd})) || (n.force = e.force, n.no_predict = e.no_predict, n.pdc.init(), n.force && (n.pdc.mark("st"), window.bds && bds.comm && !bds.comm.supportis && (n.pdc.mark("net"), n.pdc.setParam("cus_hitpreload", 1))), k(o, n)), _(e.no_predict && 6 != e.pstg
                    ? ""
                    : n.real_wd), T(n)));
            i && s && r && a(),
            n = {
    ...
    function L() {
        var t = [];
        return Ne && (t = $.map(Ne.slice(0, 2), function (t) {
            return t.value
        })),
        t.join("	")
    }
    ...
    function q(t, e) {
        e
            ? (ae = !0, rn && (clearTimeout(rn), rn = !1), rn = setTimeout(function () {
                ae = ce
            }, t))
            : (re = !0, on && (clearTimeout(on), on = !1), on = setTimeout(function () {
                re = se
            }, t))
    }
    function U(t) {
        ...
        c.is_xhr = "1",
        window.bds && bds.comm && bds.comm.cur_query
            ? a.p("bs", bds.comm.cur_query)
            : a.p("bs", ""),
        window.bds && bds.comm && bds.comm.cur_disp_query && (c.is_pbs = encodeURIComponent(bds.comm.cur_disp_query));
        var d = "ie=utf-8" + (bds.comm.newindex
            ? "&newi=1"
            : "") + (ge.sid
            ? "&sid=" + encodeURIComponent(ge.sid)
            : "") + (ge.tnp
            ? "&tnp=" + encodeURIComponent(ge.tnp)
            : "") + "&mod=" + (t.no_predict || !bds.comm.supportis
            ? "1"
            : "11") + (bds.comm.supportis
            ? "&isbd=1"
            : "") + "&isid=" + ve + "&" + a.buildQueryString() + "&rsv_sid=" + bds.comm.indexSid + "&_ss=1&clist=" + encodeURIComponent(ee.getCacheList()) + "&hsug=" + encodeURIComponent(L()) + (t.force
            ? "&f4s=1"
            : "") + "&csor=" + getCursortPosition($e.get(0));
        t.pstg && (d += "&pstg=" + t.pstg);
        var l = "/s?" + d;
        if (l += "&_cr1=" + r(l), !t.no_predict) 
            for (s = ee.find(function (t) {
                return t.loaded || t.no_predict
                    ? void 0
                    : !0
            }), e = 0; e < s.length; e++) 
                ee.deleteCache(s[e]);
    if (!(t.no_predict && !t.force && (s = ee.find(function (t) {
            return t.force && a.equals(t.env)
                ? !0
                : void 0
        }), s.length > 0))) {
                ...
                f = function (e, n, o) {
                    if (0 == n) 
                        ...
                        try {
                            ...
                            $(t).one("swap_begin", function () {
                                this
                                    .base64
                                    .inline(this.b64ildata, this.html.get(0))
                            })
                        } catch (r) {} else 
                            2 == n && t.base64 && (t.base64.ilsum = e)
                },
                g = function (e, r) {
                    if (r && "302" == r.status || e && $.trim(e).indexOf("<div>") > 10) 
                        return void(t.force
                            ? (n(11), j(a))
                            : ee.deleteCache(t));
                    h(t, {
                    ...
                    if (-1 != d) {
                        ...
                        window.__dom_pre_parse && "1" == s
                            .find("#__need_parse_dom")
                            .html() && (t.html = $(t.html));
                        try {
                            var l = $.parseJSON(s.find("#img_list").text());
                            t
                                .base64
                                .loadImg(l.right, l.left),
                            t.base64_loaded = !0
                        } catch (u) {}
                        try {
                    ...
                    t.real_wd_org = s
                        ...
                        .text(),
                    t.real_wd_nosynx = s
                        .find("#__real_wd_nosynx")
                        .eq(0)
                        .text(),
                    t.env && t
                        .env
                        .p("nojc") && t.real_wd_nosynx && (t.real_wd = t.real_wd_nosynx);
                    var b = !1;
                    (a.p("wd") == i($e.val()) || t.force) && t.shouldShow && (b = !0),
                    ...
                    if (t.chk = C
                        ? C
                        : 0, !e || !v && !p && !f && !m || !w && t.force) 
                        return t.force
                            ? (a.p("__eis", 1), a.p("__eist", e
                                ? e.length
                                : 0), a.p("real_wd", t.real_wd), n(13), void j(a))
                    ...
                    for (var D = ee.find(function (e) {
                        return !e.loaded && e !== t && e.no_predict && a.equals(e.env)
                            ? (e.shouldShow && (b = !0), e.force && (t.force = !0, t.no_predict = !0), !0)
                            : void 0
                    }), R = 0; R < D.length; R++) 
                        ee.deleteCache(D[R]);
                    return t.backup_request_timeout && clearTimeout(t.backup_request_timeout),
                    t.loaded = !0,
                    bds.comm.supportis || b
                        ? void((b && t !== ze || t.force) && (y(), t.shouldShow = !1, -11 == m
                            ? t.pdc.init()
                            : t.pdc.mark("net"), k(a, t)))
                        : !0
                };
            p = $.ajax({dataType: "parts", url: l, headers: c, delimiter: "</*3*/>"}),
    ...
    window.b_rec = function (t) {
        ...
        if (t) 
            ...
            try {
                e = window.external && window.external.twGetRunPath
                    ? window
                        .external
                        .twGetRunPath()
                    : ""
    ...
    window.hash = function (t, e) {
        return t
            ? t && !e && Pe
                ? Pe.p(t)
                : void(t && e && Pe && (Pe.p(t, e), ne.href = Pe.buildSearchUrl()))
            : void 0
    };
    var B,
        F,
    ...
    bds.comm.isDebug && ($('<style data-for="debug">#debug{display:none!important;}</style>').appendTo("head"), $('<div id="debug" style="display:block;position:absolute;top:30px;right:30px;borde' +
            'r:1px solid;padding:5px 10px;z-index:10000"></div>').appendTo("#wrapper"), $(window).on("swap_end", function (t, e) {
        if (e) {
            var n = $("#isDebugInfo");
            ...
            var o = "<table>";
            for (var i in e.log) 
                e.log.hasOwnProperty(i) && (o += "<tr><td>" + i + "</td><td>" + encodeURIComponent(e.log[i]) + "</td></tr>");
            o += "</table>",
            $("#debug").html(o)
        }
    }));
    var X = function () {
        ...
        return function (e) {
            ...
            bds && bds.comm && bds.comm.js_error_monitor && (t = new Image, t.src = bds.comm.js_error_monitor + "?" + $.param({url: ne.href, time: bds.comm.serverTime, explore: navigator.userAgent, info: e, info_type: 1}))
        }
    }();
    ...
    window.getCursortPosition = function (t) {
        ...
        var K = 15,
            Y = 6e4,
            Z = window.__confirm_timeout
                ? window.__confirm_timeout
                : 1e4,
            te = bds.comm.supportis
                ? 4
                : 10,
            ee = function () {
                function t(t) {
                ...
                return {
                    ...
                    getCacheList: function () {
                        var t = $.map(e, function (t) {
                            return t && (new Date).getTime() - t.startTime > Y
                                ? !1
                                : t.querySign
                        });
                    ...
                    hasCache: function (t, n) {
                        function o(t) {
                            ...
                            return (i = t.p("wd"))
                                ? ($.grep(e, function (e) {
                                    return n.loaded && !e.loaded
                                        ? !1
                                        : void(t.equals(e.real_wd
                                            ? e.env.clone({wd: e.real_wd})
                                            : e.env) && (o = e))
                                }), o
                                    ? o
                                    : null)
        ...
        !function () {
            ...
            function o(t, e) {
                var n = "";
                if ("1" === window._thirdLinkSpeed && (n = "&qid=" + bds.comm.queryId), window._bdlksmp > 0 && (n = "&bdlksmp=" + window._bdlksmp), "1" === window._eclipse && /^\/link\?/.test(e)) 
                    return "wd=&eqid=" + bds.comm.eqid + i([
                        "pn", "rn", "ie"
                    ], t) + n;
                var o = new p(s(t));
                return o.p("wd")
            ...
            function i(t, e) {
                var n = "",
                    o = s(e);
                for (var i in t) 
                    o.hasOwnProperty(i) && (n += "&" + encodeURIComponent(o[i]));
                return n
            }
            function r(t) {
                var e = new p(s(ie.getQueryString()), !0);
                e.hashCode()
                    ? 0 == pageState && N(e)
                    : 0 != pageState
                        ? ne.replace(ne.pathname + ne.search.replace(/([?&])isidx=[^&*]&?/, "$1"))
                        : ne.search != ne
                            .search
                            .replace(/([?&])isidx=[^&*]&?/, "$1") && ne.replace(ne.pathname + ne.search.replace(/([?&])isidx=[^&*]&?/, "$1")),
                ie.onurlchange(e, t)
            }
            var a = "onhashchange" in window,
                c = "onpopstate" in window;
            window.__disable_popstate && (c = !1);
            var l = ne.pathname.length > 1
                ? ne.pathname
                : "/s";
            ...
            ie.init = function () {
                ...
                var e = t();
                /wd=/.test(e) && (c
                    ? (window.history.replaceState(null, "", l + "?" + e), m())
                    : a
                        ? u()
                        : ne.replace(l + "?" + e))
            },
            ...
            ie.clickResultLink = function (t, e, n) {
                return c
                    ? (window.history.pushState(null, "", new p(n, !0).buildSyncSearchUrl()), m(), !1)
                    : void t
                        .attr("href", e.buildSearchUrl(n))
                        .attr("target", "_self")
            },
            ie.submit = function (t, e) {
                setTimeout(function () {
                    c
                        ? (window.history.pushState(t, "", t.buildSyncSearchUrl()), m(e))
                        : a
                            ? (ne.href = t.buildSearchUrl(), u(e))
                            : ne.href = t.buildSyncSearchUrl()
                }, 0)
            },
        ...
        var re = J.disable
            ? J.disable
            : !1;
        window.__disable_preload && (re = !0);
        var se = re,
            ae = !1;
        window.__disable_predict && (ae = !0);
        var ce = ae,
            de = bds.comm.switchAddMask
                ? bds.comm.switchAddMask
                : !1;
        de || (de = window.__switch_add_mask
            ? window.__switch_add_mask
            : !1),
        de = !0;
        var le = (bds.comm.preloadMouseMoveDistance
                ? bds.comm.preloadMouseMoveDistance
                : 5, 300),
            ue = 50,
            me = 80,
            pe = 0,
        ...
        ie.support() || (!function () {
            function t() {
                ne.hash && ne
                    .hash
                    .match(/[^a-zA-Z0-9](wd|word)=/) && ne.replace("//www.baidu.com/s?" + ne.href.match(/#(.*)$/)[1])
            }
            ne
                .hash
                .match(/[^a-zA-Z0-9](wd|word)=/)
                ? (ne.replace("//www.baidu.com/s?" + ne.href.match(/#(.*)$/)[1]), function () {
                    throw new Error("redirect to sync")
                }())
                : (document.getElementById("wrapper").style.display = "block", "onhashchange" in window
                    ? window.onhashchange = t
                    : setInterval(t, 200))
        }(),
        se = re = !0);
        for (var be = Cookie.get("BAIDUID", "nobdid").split(":")[0],
        ve = be.substr(0, 6) + be.substr(be.length - 5, 5) + parseInt(99999 * Math.random()); ve.length < 16;) 
            ve += "0";
        ...
        we = $(J.index_form),
        "_blank" == we.attr("target") && (window.__disable_index_predict = !0, se = re = !0);
        ...
        var Ue,
            ...
            He = $.ajax({
                ...
                url: 1 === bds.comm.logFlagSug
                    ? "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/" +
                            "sug/js/bdsug_async_sam_sug_a97d823.js"
                    : "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/" +
                            "sug/js/bdsug_async_97a395d.js"
            }),
            We = "focus";
        !function () {
            window.PDC_ASYNC = {
            ...
            function i(t) {
                try {
                    ...
                    n > 1e3 || e > 150
                        ? (c = a
                            ? parseInt(a)
                            : 0, c >= s - o && s > c && (l = 1, Cookie.set("ispeed", 2, document.domain, "/", d)), i > c && (c = c + o > i
                            ? i
                            : c + o, Cookie.set("ispeed_lsm", c, document.domain, "/", d)))
                        : (a && parseInt(a) > s && (r = 5), a && parseInt(a) >= r && (parseInt(a) <= s + r && parseInt(a) > s && (l = 2, Cookie.set("ispeed", 1, document.domain, "/", d)), c = parseInt(a) - r, Cookie.set("ispeed_lsm", c, document.domain, "/", d))),
                    l
                } catch (p) {}
                return 0
            }
            function r() {
                return Cookie.get("ispeed") && 1 == UPS.get("isSwitch") && 2 == parseInt(Cookie.get("ispeed"))
                    ? !0
                    : !1
            }
            var s = [],
        ...
        He.done(function () {
            ...
            $e.keydown(function (t) {
                ...
                (9 == t.keyCode || 39 == t.keyCode && e == this.value.length) && bds.comm.supportis && ze && Te.text() && (t.preventDefault(), ze.real_wd != this.value && ($e.val(ze.real_wd), Ue.check()), Ue.show(), _(""), D(ze, Fe, 22)({
                    tipConfirm: !0
                }))
            }),
            Ue.on("start", function () {
                We = "focus"
            }),
            ...
            $(document).on("click", function (t) {
                return 2 == t.isTrigger || 3 == t.isTrigger
                    ? !1
                    : void Ue.hide()
            });
            var t,
                e;
            Ue.on("inputChange", function (n, o) {
                if (!(window.__sam_his_nopredict && window.bds && bds.comm && 0 == bds.comm.supportis)) {
                    if (t || (t = $e.val()), _(""), M(), clearTimeout(Qe), clearTimeout(sn), 0 == pageState && window.__disable_index_predict || re || ae || Ge.isSlow()) 
                        return void Ue.setMaxNum(10);
                    Ue.setMaxNum(te);
                    var i = new p({pn: "", wd: o.value});
                    ...
                    if (Me) 
                        return void(Me = !1);
                    if (window.__restart_confirm_timeout && I(), We = "input", ke = (new Date).getTime(), e && (clearTimeout(e), e = !1), "" == $.trim(o.value)) 
                        return void x();
                    if (Ne = o.checkStore(), !/^[a-zA-Z0-9~!@#$%^&*()_+=-]$/.test(o.value)) {
                        var s = $e.val(),
                            a = o
                                .imt
                                .getLog();
                        a.length > 0 && a[a.length - 1]
                            .type
                            .indexOf("link") > -1 && i.p("_sglink", "1");
                        var c = o
                            .imt
                            .diffLog();
                        ...
                        !window.__disable_is2 && t.length > s.length && 0 === t.indexOf(s)
            ...
            Ue.on("selectSug", function (t, e, n, o) {
                if (_(""), clearTimeout(Qe), !(0 == pageState && window.__disable_index_predict || re || ae || Ge.isSlow())) 
                    if (-1 == n) {
                        ze && Ue.setVisibleSug(ze.real_wd);
                        var i = new p({pn: "", wd: e.value});
            ...
            Ue.on("render", function () {
                ze && Ue.setVisibleSug(ze.real_wd)
            }),
            Ue.on("dataReady", function (t, e) {
                var n = e && e.queryValue && e.dataCached && e.dataCached[e.queryValue];
                if (n && n.gl) 
                    for (var o in n.gl) 
                        if (1 * n.gl[o] > 0) {
                            var i = new p({pn: "", wd: n.s[o]});
                            A({
                                env: i,
                                force: !1,
                                use_cache: !0,
        ...
        $(function () {
            $("#head")
                .delegate(".index_tab_top>a,.index_tab_bottom>a,#u1>a,#u>a", "mousedown", function () {
        ...
        v({prefix: "http://www.baidu.com", regex: /^\/*(link)\?(.*)$/}),
        v({prefix: "//www.baidu.com", regex: /^\/*(link)\?(.*)$/}),
        v({
        ...
        v({prefix: "http://bzclk.baidu.com", regex: /^\/*(adrc\.php)\?(.*)$/}),
        v({prefix: "https://sp0.baidu.com/9q9JcDHa2gU2pMbgoY3K", regex: /^\/*(adrc\.php)\?(.*)$/}),
        "https:" == ne.protocol && bds.comm.ishome && !/Chrome/.test(navigator.userAgent) && $(document).delegate("a", "mousedown", function () {
            var t = $(this),
                e = t.attr("href"),
                n = {
        ...
        ie.support() && $(document).delegate("a", "click", function () {
            ...
            return function () {
                ...
                if (!e.attr("target") || "_self" == e.attr("target")) {
                    ...
                    if (n && 0 == n.indexOf(t) && (n = n.substring(t.length)), n && (matched = n.match(/^\/*s\?(.*)/)), n && matched) {
                        var o = s(matched[0]);
                        if (o.pn || (o.pn = ""), l([
                            "baidurt", "baiduwb", "baidufir", "SE_baiduxueshu_c1gjeupa"
                        ], o.tn) < 0) {
                            ...
                            var r = ie.clickResultLink(e, Pe, o)
                        }
                        return r
                    }
                }
                ...
                return function () {
                    ...
                    t = setTimeout(function () {
                        var t = e.find(".t>a"),
                            ...
                            i = /^(http[s]?:\/\/)?([^\/]+)(.*)/,
                            r = o.match(i);
                        n && n.match(ne.protocol) && /www\.baidu\.com\/link/.test(n) && !/bdlkc=1/.test(n) && (r[2] && (o = "http://" + r[2], e.append('<link rel="dns-prefetch" href="' + o + '" />')), $.ajax({
                            url: n + "&bdlkc=1",
                            type: "GET",
        ...
        !function (t) {
            ...
            t.fn.textWidth = function () {
                e || (e = t('<div data-for="result" style="clear:both;display:block;visibility:hidden;positio' +
                        'n:absolute;top:0;"><span style="width;inherit;margin:0;font:16px/22px arial;"></' +
                        'span></div>').appendTo("body").find("span")),
        ...
        $(window).on("swap_end", function (t, e) {
            e && (window.cfpromise = new $.Deferred, De && (clearTimeout(De), De = !1, Re = null), e.confirm = !1, e.force
                ? D(e, Fe, 20)()
                : (Re = D(e, Fe, 21), De = setTimeout(Re, Z)))
        }),
        ...
        $(function () {
            ...
            he = function () {
                ...
                e
                    ...
                    .not("title")
                    .not("script[async]")
                    .not('link[href*="passport"]')
                    .remove()
            }
        }),
        bds.comm.resultPage && O(),
        Ye.delegate("#s_tab a", "mousedown", function () {
            setHeadUrl(this)
        })
            .delegate("#s_tab a", "focusin", function () {
                setHeadUrl(this)
            }),
        Ae.delegate("#page strong+a,#page a.n", "mouseover", function () {
            A({
        ...
        $("#u .back_org").click(function () {
            ...
            Pe
                ? ne.replace(Pe.buildSyncSearchUrl({
                    _r: Math.random()
                }))
                : ne.href = "/"
        }),
        ...
        $e.bind("paste", function () {
            if (!(window.__disable_index_predict && 0 == pageState || re || ae)) {
                var t = this,
                    e = this.value;
                Me = !0,
                setTimeout(function () {
    ...
    function user_c(t) {
        var e = "",
            ...
            s = window["BD_PS_C" + (new Date).getTime()] = new Image,
            a = bds && bds.util && bds.util.domain
                ? bds
                    .util
                    .domain
                    .get("http://nsclick.baidu.com")
        ...
        return i = "&mu=" + r,
        s.src = a + "/v.gif?pid=201&pj=psuser&" + e + "path=" + r + "&wd=" + n + "&t=" + (new Date).getTime(),
        !0
    }
    function initPassV3() {
        var t = bds.comm.passnew
            ? 3
            : 2;
        bds.se.passv3 = passport
            .pop
            .init({
                apiOpt: {
                    loginType: 1,
    ...
    function isp_hijack(t) {
        var e,
            ...
            r = !1;
        bds.comm.query || (r = !0),
        1 == t.stat && (e = document.createElement("div"), e.innerHTML = '<div style="zoom:1;_margin-left:1024px;"><div style="position:relative;_float:le' +
                'ft;_margin-left:-1024px;"><div style="width:100%;min-width:1024px;"><div style="' +
                'border:2px solid #fd9162;zoom:1;overflow:hidden;padding:0 0 6px 12px;"><div styl' +
                'e="position:relative;width:100%;*overflow:auto;padding-top:10px;"><div style="he' +
                'ight:18px;margin-bottom:6px;"><i class="c-icon" style="width:18px;height:18px;ba' +
                'ckground-position:-168px -72px;"></i><strong style="display:inline-block;margin-' +
                'left:8px;font-size:14px;color:#666;">百度提示您：</strong></div><span style="display:b' +
                'lock;color:#333;text-indent:26px;font-size:13px;">我们发现当前您可能受到异常广告弹窗的影响，通常这是受第三方恶' +
                '意劫持导致。使用 <a href="http://shadu.baidu.com/landingpage/competing.html?from=10064" ' +
                'target="_blank" style="color:#0000D0;text-decoration:underline">防恶意广告专版杀毒软件</a>，' +
                '可有效改善您的上网体验，免受恶意广告的困扰。</span><a id="isp-close-btn" style="display:inline-block;w' +
                'idth:9px;height:9px;position:absolute;top:6px;right:6px;background:url(https://s' +
                's1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/global/im' +
                'g/wsCloseBtn2_0047ae2.png) no-repeat;" href="javascript:void(0);"></a></div></di' +
                'v></div></div></div>',
        r
            ? i.insertBefore(e, i.children[0])
            : (i.style.position = "relative", document.getElementById("u").style.top = 0, e.style.margin = "-6px 0 8px 0", document.body.insertBefore(e, i)), n = document.getElementById("isp-close-btn"), o = n.parentNode.getElementsByTagName("a")[0],
        n.onclick = function () {
            r
                ? i.removeChild(e)
                : (document.body.removeChild(e), i.style.position = "", document.getElementById("u").style.top = "4px")
        },
    ...
    function isbase64(t) {
        ...
        function o(t) {
            for (var e = t, n = 0; __callback_names.hasOwnProperty(t) || window[t];) 
                t = e + "_" + n,
                n++;
        ...
        bds && bds._base64
            ? c = bds._base64
            : (c = {
                domain: bds.util.domain && bds.util.domain.get
                    ? bds
                        .util
                        .domain
                        .get("http://b1.bdstatic.com/")
    ...
    function langChangeUrl(t, e, n) {
        ns_c({fm: "advTool", qid: bds.comm.qid, title: encodeURI(n), rsv_advTool_lang: e}),
    ...
    function fileChangeUrl(t, e, n) {
        ns_c({fm: "advTool", qid: bds.comm.qid, title: encodeURI(e), rsv_advTool_ft: n}),
        baseChangeUrl("wd=" + encodeURIComponent(queryReplace("filetype", t)))
    }
    function queryReplace(t, e) {
        if (!t || "filetype" != t && "site" != t) 
            return o;
    ...
    function extChangeUrl(t) {
        t
            ? (ns_c({fm: "advTool", qid: bds.comm.qid, title: encodeURI("精确匹配"), rsv_advTool_ext: 1}), baseChangeUrl('wd="' + encodeURIComponent($("#kw").val()) + '"'))
            : (ns_c({fm: "advTool", qid: bds.comm.qid, title: encodeURI("智能匹配"), rsv_advTool_ext: 0}), baseChangeUrl("wd=" + encodeURIComponent($("#kw").val().replace(/^\"(.*)\"$/, "$1"))))
    }
    var define,
        require,
        esl;
    !function (t) {
        ...
        function n(t, e) {
            ...
            if ("string" == typeof t
                ...
                throw new Error("[REQUIRE_FATAL]Relative ID is not allowed in global require: " + i.join(", "));
            var r = H.waitSeconds;
        ...
        function o() {
            function t(s, a) {
                if (!r[s] && !m(s, P)) {
                    ...
                    var c = E[s];
                    c
                        ? (a || !m(s, M) || c.hang) && (o[s] || (o[s] = 1, e.push(s)), A(c.depMs, function (e) {
                            t(e.absId, e.hard)
                        }))
                        : i[s] || (i[s] = 1, n.push(s))
                }
            ...
            if (e.length || n.length) 
                throw new Error("[MODULE_TIMEOUT]Hang(" + (e.join(", ") || "none") + ") Miss(" + (n.join(", ") || "none") + ")")
        }
        function i(t) {
            A(W, function (e) {
        ...
        function r(t, e, n) {
            if (null == n && (null == e
                ? (n = t, t = null)
                : (n = e, e = null, t instanceof Array && (e = t, t = null))), null != n) {
                var o = window.opera;
        ...
        function c(t) {
            ...
            if (e && !m(t, N)) {
                var n = e.deps,
                    o = e.factory,
                    i = 0;
                "function" == typeof o && (i = Math.min(o.length, n.length), !e.depsDec && o.toString().replace(/(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm, "").replace(/require\(\s*(['"])([^'"]+)\1\s*\)/g, function (t, e, o) {
                    n.push(o)
                }));
                var r = [],
                    s = [];
                A(n, function (n, o) {
                    ...
                    l && !B[l]
                        ? (d.res && (c = {
                            ...
                            absId: l,
                            hard: i > o
                        }, e.depMs.push(a), e.depMkv[l] = a, r.push(l)))
                        : a = {
                            absId: l
                        },
                    i > o && e
                ...
                u(t),
                b(r),
                s.length && e.require(s, function () {
                    A(e.depRs, function (e) {
        ...
        function l(t) {
            function e(t) {
                ...
                var o = E[t],
                    i = !0;
                return A(o.depMs, function (t) {
                    i = e(t.absId) && i
                }),
                i && A(o.depRs, function (t) {
                    return i = !!t.absId
                }),
                i && !m(t, M) && (o.state = M),
                n[t] = 0,
        ...
        function v(e) {
            ...
            function o() {
                if (s) {
                    ...
                    null == n && s.exports && (n = t, A(s.exports.split("."), function (t) {
                        return n = n[t],
                        !!n
                    })),
                    r(e, a, function () {
        ...
        function y() {
            ...
            var e = J[J.length - 1];
            e && "*" === e.k && A(J, function (t) {
                t != e && (t.v = t.v.concat(e.v))
            }),
            X = [],
            A(H.packages, function (t) {
                var e = t;
                "string" == typeof t && (e = {
                    name: t.split("/")[0],
                    location: t,
        ...
        function $(t, e) {
            ...
            var a,
                c = r;
            return x(r, V, function (t, e) {
                c = c.replace(e, t),
                a = 1
            }),
            a || x(r, X, function (t, e, n) {
        ...
        function A(t, e) {
            if (t instanceof Array) 
                for (var n = 0, o = t.length; o > n && e(t[n], n) !== !1; n++) ;
                }
            function L(t, e) {
            var n = t.k || t.name,
                o = e.k || e.name;
        ...
        function j() {
            if (Z) 
                return Z;
            if (te && "interactive" === te.readyState) 
                return te;
        ...
        var V,
            ...
            Z,
            te,
            ee = document.getElementsByTagName("head")[0],
    ...
    bds.amd = {
        ...
        exist: function (t) {
            return t && "undefined" != typeof bds.amd.keys[t]
                ? !0
                : !1
        }
    },
    function () {
        var t = bds.util && bds.util.domain
                ? bds
                    .util
                    .domain
                    .get("http://s1.bdstatic.com")
                : "http://s1.bdstatic.com",
            e = bds.util && bds.util.domain
                ? bds
                    .util
                    .domain
                    .get("http://ecmb.bdimg.com")
                : "http://ecmb.bdimg.com";
        require.config({
    ...
    bds
        .amd
        .addPaths({
            "voice/js/voice": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/" +
                    "voice/js/voice_1e62c0f",
            "plugins/swfobject": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/" +
                    "plugins/swfobject_0178953",
            "soutu/js/tu": "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/" +
                    "soutu/js/tu_329aca4"
        }),
    ...
    jQuery && jQuery.extend({
        stringify: function (t) {
            function e(t) {
                return /["\\\x00-\x1f]/.test(t) && (t = t.replace(/["\\\x00-\x1f]/g, function (t) {
                    ...
                    return e
                        ? e
                        : (e = t.charCodeAt(), "\\u00" + Math.floor(e / 16).toString(16) + (e % 16).toString(16))
                })),
                '"' + t + '"'
            }
            function n(t) {
        ...
        format: function (t, e) {
            ...
            return n.length
                ? (n = 1 == n.length && null !== e && /\[object Array\]|\[object Object\]/.test(o.call(e))
                    ? e
        ...
        subByte: function (t, e, n) {
            ...
            for (var r = 0, s = i.length; s > r; r++) 
                i[r].charCodeAt(0) > 255 && o.push("*"),
                o.push(i[r]);
            return e && e > 0 && o.length > e
                ? i = o
                    .join("")
                    .substring(0, e - 1)
                    .replace(/\*/g, "") + n
        ...
        getByteLength: function (t) {
            for (var e = [], n = t.split(""), o = 0, i = n.length; i > o; o++) 
                n[o].charCodeAt(0) > 255 && e.push("*"),
                e.push(n[o]);
            return e.length
        },
        ...
        getCookie: function (t) {
            ...
            if (jQuery._isValidKey(t)) {
                ...
                if (o && (e = o[2] || null, "string" == typeof e)) 
        ...
        limitWd: function (t, e) {
            ...
            if (o <= parseInt(r / 2)) 
                return t;
            for (var s = 0; o > s; s++) {
                if (i += n[s].charCodeAt(0) > 255
                    ? 2
                    : 1, i === r) 
                    return n = t.substring(0, s + 1);
                if (i > r) 
                    return n = t.substring(0, s)
            }
            return t
        }
    }),
    ...
    bds.util.setContainerWidth = function () {
        ...
        bds
            .util
            .getWinWidth() < 1207
            ? (t && (n(/\bcontainer_l\b/g, t), i(/\bcontainer_s\b/, t) || o("container_s", t)), e && (n(/\bwrapper_l\b/g, e), i(/\bwrapper_s\b/, e) || o("wrapper_s", e)), bds.comm.containerSize = "s")
            : (t && (n(/\bcontainer_s\b/g, t), i(/\bcontainer_l\b/, t) || o("container_l", t)), e && (n(/\bwrapper_s\b/g, e), i(/\bwrapper_l\b/, e) || o("wrapper_l", e)), bds.comm.containerSize = "l")
    },
    function () {
        var t = [],
            e = !1,
        ...
        var i = function () {
                ...
                return function () {
                    ...
                    for (var n = e; n;) {
                        if (n.className && /(?:^|\s)result(?:-op)?(?:$|\s)/.test(n.className) && (tplname = n.getAttribute("tpl"))) 
                            return n;
                        n = n.parentNode
                    }
                }
            ...
            r = function (t, e, n) {
                var o;
                if (t.initIndex
                    ? o = A.groupData[t.initIndex - 1]
                    : (o = {
                        container: t,
                        data: {},
                        handlers: []
                    }, t.initIndex = A.groupData.length + 1, A.groupData.push(o)), "function" == typeof e) 
                    o.handlers.push(e);
                else if ("object" == typeof e) 
                    for (var i in e) 
                        e.hasOwnProperty(i) && (o.data[i] = e[i]);
            else 
                    o.data[e] = n
            };
    ...
    function () {
        var t = window.bds.aladdin,
            ...
            d = function () {
                for (var t, e, n = $(".result-op").get().concat($(".result").get()), o = {}, i = 0; e = n[i]; i++) 
                    (t = e.getAttribute("tpl")) && (o[t]
                        ? o[t].push(e)
                        : o[t] = [e]);
                return o
            },
            ...
            ajax: function (e, n, o) {
                ...
                var e = $.param(l),
                    ...
                    h = function (t) {
                        a(h) && (b(), 0 == t.status
                            ? o.success(t.data)
                            : (o.error && o.error(t.status), m()), f(0))
                    },
                    g = function () {
        ...
        t.AJAX = {
            API_URL: bds.util.domain && bds.util.domain.get
                ? bds
                    .util
                    .domain
                    .get("http://opendata.baidu.com/api.php")
                : "http://opendata.baidu.com/api.php",
            ERR_URL: bds.util.domain && bds.util.domain.get
                ? bds
                    .util
                    .domain
                    .get("http://open.baidu.com/stat/al_e.gif?ajax_err_url=#{url}")
        ...
        e.push(function (t) {
            var e = /msie (\d+\.\d+)/i.test(navigator.userAgent)
            ...
            if (e) {
                ...
                $.each(t.container.getElementsByTagName("form"), function (t, e) {
                    var o = function () {
                        ...
                        t && "UNKNOWN" != t
                            .toString()
                            .toUpperCase() && t != document.charset && (document.charset = t, setTimeout(function () {
                            document.charset = n
                        }, 1e3))
                    };
                    $(e).on("submit", o);
        ...
        t.__runAla = function () {
            var n = d();
            $.each(t.mergeFns, function (e, o) {
                var i = n[o.tplName];
                i && $.each(i, function (e, n) {
                    t._currentContainer = n,
                    o.fn(),
                    t._currentContainer = null
                })
            }),
            $.each(t.groupData, function (n, o) {
                var r,
                    s,
                    a,
                    c = new t._Aladdin;
                ...
                t
                    ...
                    .push(c);
                var d = o.handlers;
                for (r = new Date; d.length;) 
                    i(d.shift(), c);
                
                "function" == typeof c.dispose && (l.push({obj: c, fn: c.dispose}), c.dispose = null),
                s = new Date,
                a = {
                    srcid: c.srcid
                },
    ...
    function () {
        function t(r, s) {
            ...
            if (a.length > 1) 
                if (s) 
                    ...
                    if (r = a[0], "jquery" === r && window.jQuery) 
                        return !i.ui.jquery && (i.ui.jquery = window.jQuery),
                        void(s && s());
            var c = r.replace(/\./g, "/"),
                    d = r.replace(/^[\s\S]*\./, ""),
                    l = i.uiPrefix + c + "/" + d;
                0 == c.search("style/")
                    ? e(l + ".css", s)
                    : (l += ".js", m.hasOwnProperty(r)
                        ? "function" == typeof m[r]
                            ? l = m[r](r, l)
                            : "string" == typeof m[r] && (l = m[r])
                        : m.hasOwnProperty("*") && (l = m["*"](r, l)), s
                        ? o(l, s)
                        : n(l))
            }
        }
        ...
        function n(t) {
            return l
                ? void o(t, u)
                : void(t in r || (c.write('<script charset="gb2312" type="text/javascript" src="' + t + '"></script>'), r[t] = 1))
        }
        function o(t, e) {
            if (e = e || u, t in r) 
                return void e();
            if (t in s) 
                return void a[t].push(e);
            s[t] = 1;
            var n = a[t] = [e],
            ...
            $(".c-feedback").bind("click", function () {
                ...
                i.use("ALD_feedback", function () {
                    var e,
                        ...
                        r = $(t);
                    r
                        .parents("#content_left")
                        .length
                        ? (o = "left", n = r.parents(".result-op"), e = n.attr("srcid"))
                        : r
                            .parents("#content_right")
                            .length && (n = r.parents("#con-ar"));
                    var s = {
                        ...
                        a = i
                            .ui
                            .ALD_feedback(s);
                    i.addDisposeHandler({obj: a, fn: a.dispose})
                })
            })
        })
    }(),
    ...
    bds.event = new function () {
        function t(t, e) {
            if ("function" == typeof e || e instanceof Function) {
                var n = i(t);
                r[n.name] = r[n.name] || [],
                r[n.name].push({prod: n.prod, callback: e})
            }
        }
        function e(t, e) {
            for (var n = i(t), s = r[n.name] || [], a = 0; a < s.length;) {
                var c = s[a];
                e === c.callback && o(n.prod, c.prod)
                    ? s.splice(a, 1)
                    : a++
            }
        }
    ...
    bds.se.link = function () {
        function t(t, e) {
            ...
            e && (o = $.extend(o, e));
            for (var r in o) 
                o.hasOwnProperty(r) && (i += "&" + r + "=" + encodeURIComponent(o[r]));
            return n + i
        }
    ...
    !function (A) {
        ...
        function getXPath(t, e, n) {
            if (n = n || [], e = e || document, t === e) 
                return n;
            if (t.parentNode !== e && (n = getXPath(t.parentNode, e, n)), t.previousSibling) {
                var o = 1,
                    i = t.previousSibling;
                do 
                    1 == i.nodeType && i.nodeName == t.nodeName && o++,
                    i = i.previousSibling;
                while (i)
            }
            return 1 == t.nodeType && n.push(t.nodeName.toLowerCase() + (o > 1
                ? o
                : "")),
            n
        }
        function bindLogEvent() {
            ...
            $body.on("mousedown", function (t) {
                var t = window.event || t,
                    ...
                    n = $(e);
                try {
                    for (var o, i, r = n; r.length && !(r.hasClass("result") || r.hasClass("result-op") || r.hasClass("xpath-log"));) 
                        r = r.parent();
                    if (!r.length) 
                        return;
                    r.hasClass("result-op")
                        ? o = "alop"
                        : r.hasClass("result") && (o = "as"),
                    i = r.get(0);
                    var s = getXPath(e, i);
        ...
        function getType(t, e, n) {
            for (var o = e, i = LOG_CLASS, r = i.length, s = C_LOG_CLASS, a = s.length, c = t.join(" "), d = 0; o !== n;) {
                for (d = 0; r > d; d++) 
                    if ($(o).hasClass("OP_LOG_" + i[d])) 
                        return i[d].toLowerCase();
            for (d = 0; a > d; d++) 
                    if ($(o).hasClass("c-" + s[d])) 
                        return s[d];
            o = o.parentNode
            }
            return /\bh3\d*\b/.test(c)
                ? "title"
                : /\ba\d*\b/.test(c)
                    ? /\bimg\d*\b/.test(c)
                        ? "img"
                        : "link"
                    : /\b(input|select|button|textarea|datalist)\d*\b/.test(c)
                        ? "input"
                        : /\blabel\d*\b/.test(c) && e
            ...
            if (null == e.getAttribute("data-nolog")) {
                ...
                if ("input" == i) 
                    if (/input|textarea/.test(f)) 
                        ...
                        p = e.innerHTML || e.value || "";
            else if ("img" == f && (p = e.title), !p) 
                    for (; l > 0;) {
                        if (l--, /^a\d*\b/.test(t[l])) {
                            if (d = u.href, p = u.innerHTML, null != u.getAttribute("data-nolog")) 
                                return;
                            break
                        }
                ...
                do 
                    {
                        if(null != u.getAttribute("data-nolog")) 
                            return;
                if (v = u.getAttribute("data-click")) 
                        try {
                ...
                if ("title" == i
                    ...
                    : g.mu || (g.mu = s), _) 
                    "fm" in g && delete g.fm;
                else if ("input" == i && (g.fm = "beha", g.url = r), g.fm || (g.fm = o), !g.fm) 
                    return;
                window.c(g)
            }
        }
    ...
    bds.se.openime = function (t) {
        window.bdime
            ...
            : $.ajax({
                cache: !0,
                dataType: "script",
                url: "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/" +
                        "plugins/ime_c5abb66.js",
                success: function () {
                    t && openIme.set("py", !0)
                }
            })
    ...
    bds.util.setContainerWidth = function () {
        ...
        if (1217 > n) 
            t.removeClass("container_l container_xl").addClass("container_s"),
            ...
            if (!(n >= 1217)) 
                return;
            t
                .removeClass("container_s container_xl")
                .addClass("container_l"),
            e
                .removeClass("wrapper_s")
                .addClass("wrapper_l"),
    ...
    bds.se.tip = function (t) {
        this.init = function () {
            ...
            t.arrow && (this.op.arrow.has = 0 == t.arrow.has
                ? 0
                : 1, this.op.arrow.offset = t.arrow.offset >= 0
                ? t.arrow.offset
                : 10, this.op.arrow.r = t.arrow.r, this.op.arrow.c = t.arrow.c),
            t.offset && (this.op.offset.x = t.offset.x || 0 == t.offset.x
                ? t.offset.x
                : 10, this.op.offset.y = t.offset.y || 0 == t.offset.y
                ? t.offset.y
                : 20),
            this.ext = t.ext || {},
            ...
            this.visible = !1,
            this.rendered = !1,
            this.isAuto = "auto" === this.op.align
                ? !0
                : !1,
            this.bindEvent()
        },
        ...
        this.enableArrow = function () {
            if (this.op.arrow.r) 
                var t = $("<div>", {"class": "c-tip-arrow"}).html("<em></em><ins class='c-tip-arrow-r'></ins>").appendTo(this.dom);
            else if (this.op.arrow.c) 
                var t = $("<div>", {"class": "c-tip-arrow"}).html("<em></em><ins class='c-tip-arrow-c'></ins>").appendTo(this.dom);
            else 
                var t = $("<div>", {"class": "c-tip-arrow"})
                    .html("<em></em><ins></ins>")
                    .appendTo(this.dom);
            this.arrow = t
        },
        this.enableCloseIcon = function () {
            var t = this,
                e = $("<div>", {"class": "c-tip-close"})
                    .html("<i class='c-icon c-icon-close'></i>")
                    .appendTo(this.dom)
                    .click(function () {
                        t.hide()
                    });
        ...
        this.setTitle = function (t) {
            if (t.nodeType) 
                var e = $("<h3>", {"class": "c-tip-title"}).append(t).appendTo(this.dom);
            else 
                var e = $("<h3>", {"class": "c-tip-title"})
                    .html(t)
                    .appendTo(this.dom);
            this.title = e
        },
        ...
        this.setArrow = function (t) {
            if (t && t.offset >= 0 && (this.op.arrow.offset = t.offset), this.op.arrow.has && this.arrow) 
        ...
        this.setOffset = function (t) {
            switch (t && (this.op.offset.x = t.x || 0 == t.x
                ? t.x
                : this.op.offset.x, this.op.offset.y = t.y || 0 == t.y
                ? t.y
                ...
                case "right":
                    ...
                    this
                        ...
                        .css({
                            top: e.top + this.op.offset.y + "px",
                            left: e.left + this.op.offset.x + $(this.getTarget()).width() - this
                                .getDom()
                                .width() + "px"
                        })
            }
        ...
        this.autoOffset = function () {
            var t,
                ...
                d = {};
            a.h + s - i.h - o.top > e.h
                ? (c.top = i.h + o.top + this.op.arrowSize / 2, this.arrow && this.arrow.removeClass("c-tip-arrow-down"))
                : o.top - s > e.h
                    ? (c.top = o.top - e.h - this.op.arrowSize / 2, this.arrow && this.arrow.addClass("c-tip-arrow-down"))
                    : (c.top = i.h + o.top + this.op.arrowSize / 2, this.arrow && this.arrow.removeClass("c-tip-arrow-down")),
            t = o.left + i.w / 2 - this.op.arrow.offset - this.op.arrowSize / 2,
            c.left = t,
            c.left > 0 && c.left + e.w > a.w
                ? (c.left = o.left + i.w / 2 - e.w + this.op.arrow.offset + this.op.arrowSize / 2, d.right = this.op.arrow.offset + this.op.arrowSize, d.left = "auto", c.left < 0 && (c.left = t, d.left = this.op.arrow.offset, d.right = "auto"))
                : (d.left = this.op.arrow.offset, d.right = "auto"),
            this
                .dom
                .css(c),
            this.arrow && this
        ...
        this.show = function () {
            this.visible || (this.onShow(), this.rendered || (bds.comm.tips.push(this), this.render(), this.rendered = !0), this.isAuto
                ? this.autoOffset()
                : (this.setOffset(), this.setArrow()), this.dom.css({"z-index": bds.comm.tipZIndex}), bds.comm.tipZIndex++, this.dom.css({display: "block"}), this.visible = !0)
        },
        this.hide = function () {
    ...
    bds
        .event
        .trigger("se.api_tip_ready"),
    $(document).mousedown(function (t) {
        t = t || window.event;
        for (var e = t.target || t.srcElement; e && e.tagName && e != document.body && "html" != e.tagName.toLowerCase() && "c-tip-con" != e.className;) 
            e = e.parentNode;
    ...
    !function () {
            ...
            try {
                window.sidebar
                    ...
                    : window.opera && window.print
                        ? (t.setAttribute("rel", "sidebar"), t.setAttribute("href", e), t.setAttribute("title", o), t.click())
                        : window
                            .external
                            .AddFavorite(e, o)
            } catch (n) {}
        ...
        n) 
            try {
                ...
                try {
                    h =+ external
                        .twGetVersion(external.twGetSecurityID(window))
                        .replace(/\./g, "") > 1013
                } catch (g) {}
                if (r || h || s || a || c || d || l || u || m || p || f) {
                    var b = document.getElementById(sethfPos
                        ? "set_f"
                        : "setf");
                    b && sethfPos && (t(b), i = "favorites")
                } else {
                    var v = document.getElementById(sethfPos
                        ? "set_f"
                        : "setf");
        ...
        i && sethfPos && ns_c({fm: "sethf_show", tab: i})
    }(),
    ...
    bds.se.login = function () {
        var t = "",
            ...
            i = function (o) {
                e
                    ? (bds.se.passv3.setSubpro(t), bds.se.passv3.setMakeText(n), bds.se.loginCallbackFunc = o || function () {
                        window
                            .document
                            .location
                            .reload(!0)
                    ...
                    : $.getScript(location.protocol + "//passport.baidu.com/passApi/js/uni_login_wrapper.js?cdnversion=" + (new Date).getTime(), function () {
                        ...
                        bds
                            ...
                            .passv3
                            .setMakeText(n),
                        bds.se.loginCallbackFunc = o || function () {
                            window
                                .document
                                .location
                                .reload(!0)
            ...
            r = function (t) {
                if (bds.comm) {
                    ...
                    bds
                        ...
                        .loginCallbackFunc
                        .call(window, 1, t);
                    for (var e = 0; e < bds.comm.loginAction.length; e++) 
                        bds.comm.loginAction[e].call(window, 1, t)
                }
            },
            s = function (e) {
                t = e
        ...
        return {setUserInfo: o, open: i, success: r, setSubpro: s, setMakeText: a}
    }(),
    ...
    !function () {
        function t() {
            var t,
                e = "http://isphijack.baidu.com/index.php?cb=isp_hijack",
                n = [];
            if (top.location != self.location) {
                try {
                    for (var o = top.document.getElementsByTagName("frame"), i = top.document.getElementsByTagName("iframe"), r = 0; r < o.length; r++) 
                        n.push(o[r].getAttribute("src"));
                    for (var r = 0; r < i.length; r++) 
                        n.push(i[r].getAttribute("src"))
                } catch (s) {}
                ns_c({
                    fm: "frm",
    ...
    bds.comm.host = {
        ...
        favo: bds.util.domain && bds.util.domain.get
            ? bds
                .util
                .domain
                .get("http://i.baidu.com")
            : "http://i.baidu.com",
        share: bds.util.domain && bds.util.domain.get
            ? bds
                .util
                .domain
                .get("http://bdimg.share.baidu.com/static/api/js/custom/resultshare.js")
        ...
        this.render = function () {
            ...
            fromType = $(item)
                ...
                ? $(item)
                    ...
                    .attr("data-from")
                : "ps_pc";
            var toolsKoubei = $("<li>").html("<a target=\"_blank\" onmousedown=\"ns_c({'fm': 'tools','tab':'koubei'})\" href=" +
                    "\"" + bds.comm.host.bfe + "?url=" + encodeURIComponent(ops.url) + "&jump=" + encodeURIComponent(bds.comm.host.koubei + "/p/sentry?title=" + encodeURIComponent(ops.title) + "&q=" + encodeURIComponent(bds.comm.query) + "&from=" + encodeURIComponent(fromType)) + '&key=surl">评价</a>');
            ...
            var toolsReport = $("<li>").html("<a target=\"_blank\" onmousedown=\"ns_c({'fm': 'tools','tab':'report'})\" href=" +
                    "\"" + bds.comm.host.bfe + "?url=" + encodeURIComponent(ops.url) + "&jump=" + encodeURIComponent(bds.comm.host.report + "/jubao/accu/?title=" + encodeURIComponent(ops.title) + "&q=" + encodeURIComponent(bds.comm.query) + "&has_gw=" + isOffical + "&has_v=" + vLevel) + '&key=surl">举报</a>');
    ...
    bds.se.tool.favo.succ = function (json) {
        if (json.suc) {
            if (json.status) 
                switch (json.status) {
                    case 302:
                        bds.se.login && bds.se.login.open && bds
                            .se
                            .login
                            .open(function (stat, user) {
                                1 == stat && bds
                                    .se
                                    .tool
                                    .favo(eval("(" + $("#" + json.id)[0].getAttribute("data-tools") + ")"), json.id)
                            });
                        break;
                    case 5:
            ...
            switch (succContent += '<h3 class="c-tip-notice-succ">已收藏至：</h3>', succContent += "<ul>", json.status) {
                case 2:
                    succContent += '<li class="c-tip-item-succ"><i class="c-icon c-icon-success"></i>个人中心“<a href="h' +
                            'ttp://i.baidu.com/my/collect" target="_blank">我的收藏</a>”</li>',
                    succContent += '<li class="c-tip-item-succ"><i class="c-icon c-icon-success"></i>百度首页“<a href="h' +
                            'ttp://www.baidu.com" target="_blank">我的导航</a>”</li>';
                    break;
                case 3:
                    succContent += '<li class="c-tip-item-succ"><i class="c-icon c-icon-success"></i>个人中心“<a href="h' +
                            'ttp://i.baidu.com/my/collect" target="_blank">我的收藏</a>”</li>',
                    succContent += '<li class="c-tip-item-fail"><i class="c-icon c-icon-fail"></i>百度首页“<a href="http' +
                            '://www.baidu.com" target="_blank">我的导航</a>”</li>';
                    break;
                case 4:
                    succContent += '<li class="c-tip-item-fail"><i class="c-icon c-icon-fail"></i>个人中心“<a href="http' +
        ...
        $("#container").delegate(".c-tools", "mouseover", function () {
            ...
            t = setTimeout(function () {
                ...
                $(bds.comm.tips).each(function () {
                    return this.getTarget() == $(".c-icon", e)[0]
                        ? (t = 0, this.show(), !1)
                        : void 0
                }),
            ...
            delayShowOnTip = setTimeout(function () {
                $(bds.comm.tips)
                    .each(function () {
                        return this
                            .getDom()
                            .get(0) == t && this.ext.category && "tools" == this.ext.category
                            ? (this.show(), !1)
                            : void 0
                    })
            }, 200)
                ...
                delayHideOnTip = setTimeout(function () {
                    $(bds.comm.tips)
                        .each(function () {
                            return this
                                .getDom()
                                .get(0) == e && this.ext.category && "tools" == this.ext.category
                                ? (this.hide(), !1)
                                : void 0
                        })
                }, 200)
    ...
    bds.se.slide = function (t) {
        ...
        this.timer = [],
        this.otherTimer = [],
        this.op = $.extend({}, s._default, t),
        this.init = function () {
            return s.op.src
                ? (s.createDom(), void(bds.comm.ishome && s.op.target.length && s.initAnimate()))
                : void s.createPlayer()
        },
        this.createPlayer = function () {
            var t = s
                ...
                e = t.length
                    ...
                    : "",
                o = s.op.play;
            o && (n = $('<img class="logo_player" src="' + o.src + '" style="width:' + o.width + "px; height:" + o.height + "px; position:absolute; top:50%; left:50%; margin-left: -" + o.width / 2 + "px; margin-top: -" + o.height / 2 + "px; cursor:pointer;\" onmousedown=\"return c({'tab':'logo_button_click'})\" />").appendTo(s.op.target), e.length
                ? (n.wrap('<a style="position:absolute;top:0;left:50%;width:' + s.op.width + "px;height:" + s.op.height + "px;margin-left:-" + s.op.width / 2 + 'px;" href="' + e.attr("href") + '" target="' + e.attr("target") + '"></a>'), e.attr("title") && n.attr("title", e.attr("title")))
                : n.wrap('<div style="position:absolute;top:0;left:50%;width:' + s.op.width + "px;height:" + s.op.height + "px;margin-left:-" + s.op.width / 2 + 'px;"></div>'), n.on(o.trigger_type, function () {
                return o.trigger_duration
                    ? s
                        .timer
                        .push(window.setTimeout(function () {
                            o
                                .trigger_fn
                                .call(s.op)
                        }, o.trigger_duration))
        ...
        this.createDom = function () {
            var t = '<div style="position:absolute;top:0;left:50%;background:url(#{0}) no-repeat #{1}' +
                        ';cursor:#{2};width:#{3}px;height:#{4}px;margin-left:-#{5}px;display:none;"></div' +
                        '>',
                ...
                p = m
                    ? "pointer"
                    : p,
                f = s.op.animations instanceof Array
                    ? s.op.animations
                    : [s.op.animations],
                h = s.op.width,
                g = s.op.height;
            ...
            m.length
                ? (e.wrap('<a href="' + m.attr("href") + '" target="' + m.attr("target") + '"></a>'), m.attr("title") && e.attr("title", m.attr("title")))
        ...
        this.initAnimate = function () {
            ...
            if (!(l >= d.length)) {
                ...
                i
                    ...
                    : r && (s.enablePointer(), o.show().on(r, function () {
                        a && (m && s.toPos(m), a.call(s.op), c
        ...
        this.enablePointer = function () {
            bds.comm.upn && "msie" === bds.comm.upn.browser && "6" === bds.comm.upn.ie
                ? alert("pointer")
        ...
        this.animation = function () {
            ...
            if (t = g
                ...
                var v = t.trigger_type,
                    ...
                    y = t.trigger_frame;
                v && (f && o.off(f), l < d.length - 1 || g
                    ? (s.enablePointer(), o.on(v, function () {
                        g || l++,
                        p && p.call(s),
                        w && w.call(s),
                        y && s.toPos(y),
                        _
                            ? (s.dispose(), s.timer.push(setTimeout(function () {
                                s.play()
                            }, _)))
                            : s.play()
                    }))
            ...
            !function () {
                ...
                s
                    ...
                    .push(setTimeout(function () {
                        ...
                        h >= c
                            ? (s.dispose(), b++, 0 !== m && b >= m
                                ? (h = null, b = null, p && p.call(s), l++, l < d.length && s.play(), g && l--)
                                : (h = a - 1 > 0
                                    ? a - 1
                                    : 0, s.timer.push(setTimeout(arguments.callee, r))))
                            : s
                                .timer
                                .push(setTimeout(arguments.callee, r))
                    }, u))
            }()
        },
    ...
    bds.se.banner = function (t, e, n) {
        this.init = function () {
            ...
            this.showNum = this.hintCookie && $.getCookie(this.hintCookie)
                ? Number($.getCookie(this.hintCookie))
                : 0,
            this.nscTab = n.nscTab || "",
            this.ishome = bds.comm && 1 == bds.comm.ishome
                ? 1
                : 0,
        ...
        this.show = function () {
            this.render(),
            this.showNum += 1,
            $.setCookie(this.hintCookie, this.showNum, {expires: 2592e6}),
            this
                .$dom_panel
                .prepend(this.bannerHtml),
        ...
        this.render = function () {
            var t = [];
            t = t.concat("WIN" !== this.bannerType
                ? [
                    '<div class="res_top_banner">', '<i class="c-icon ' + (this.hintIcon
                        ? this.hintIcon
                        : "res_top_banner_icon") + '"></i>',
                    "<span>" + this.hintText + "</span>",
                    this.downUrl
                        ? '<a href="' + this.downUrl + '" class="res_top_banner_download">立即体验</a>'
                        : "",
                    '<i class="c-icon res_top_banner_close"></i>',
                    "</div>"
                ]
                : [
                    '<div class="res_top_banner_for_win">', '<i class="c-icon ' + (this.hintIcon
                        ? this.hintIcon
                        : "res_top_banner_icon") + '"></i>',
                    "<span>" + this.hintText + "</span>",
                    this.downUrl
        ...
        this.headFloat = function () {
            ...
            $(window).scroll(function () {
                var o = n.height() || 0,
                    i = e.scrollTop();
                o >= i
                    ? t.attr("style", "position:absolute;")
                    : t.attr("style", "top:0px;_top:" + o + "px;")
            })
        },
        this.bindEvent = function () {
            if ("WIN" !== this.bannerType) {
                ...
                $(".res_top_banner_download", t).on("mousedown", function () {
                    e.hintCookie && $.setCookie(e.hintCookie, 5, {expires: 2592e6}),
                    ns_c({
                        fm: "behs",
                        tab: (1 == e.ishome
                            ? "tj_"
        ...
        $(window)
            .on("swap_end", function () {
                ...
                if (winFilter = /NT 6.1|NT 6.2|NT 6.3/i.test(navigator.userAgent), bds.comm.topHijack) 
                    ...
                    var i = "6" == e.ie
                        ? "您的浏览器采用的IE6内核已停止维护，推荐升级到更快更安全的百度浏览器！"
                        : "您的IE浏览器版本较低，即将停止更新维护，建议升级到更快、更安全的百度浏览器。";
                    bds
                        .se
                        .banner($("body")[0], i, {
    ...
    bds.se.trust = function () {
        function t() {
            ...
            $(".c-trust").each(function () {
                ...
                0 == t
                    .parent(".c-icons-inner")
                    .length && t.wrap("<span class='c-icons-outer'><span class='c-icons-inner'></span></span>"),
        ...
        function s(t, e) {
            var n = t.hint,
                ...
                r = t.webIMUrl;
            if (t && n) {
                if ("vstar" == e || "baozhang" == e || "baozhang-v" == e || "chengqi" == e || "baozhang-v-auth" == e) 
                    var s = "<div class='c-tip-cer hitcon'><ul>";
                else 
                    var s = "<div class='c-tip-info hitcon'><ul>";
                for (var c = 0; c < n.length; c++) 
                    "" != n[c]
                        ? (s += "<li ", s += n[c].icon
                            ? "class='c-tip-item-i'><img src='" + n[c].icon + "' class='c-customicon c-gap-icon-right-small c-tip-item-icon' />"
                            : ">", s += a(n[c].txt), s += "</li>")
                        : o = "none";
                s += "</ul></div>";
                var d = !1,
                    l = !1;
                "baozhang-v" == e || "baozhang-v-auth" == e
                    ? d = !0
                    : "chengqi" == e && (l = !0);
                var u = new bds
                    .se
                        ...
                        $("a", this)
                            .each(function (t) {
                                this.onmousedown = function () {
                                    ns_c({hintUrl: i, hintTpl: e, title: this.innerHTML, pos: t})
                                }
                            })
                    })
                }
        ...
        function a(t) {
            ...
            e = e
                .replace("[/url]", "</a>")
                .replace(/\[url ([^\s]*)\]/, "<a href='$1' target='_blank'>"),
        ...
        if (bds.util && bds.util.domain && bds.util.domain.get) 
            var u = bds.util.domain.get("http://tag.baidu.com");
        else 
            var u = "http://tag.baidu.com";
        var m = null,
            p = null,
            f = !1,
            h = null,
    ...
    $(function () {
        bds.comm.user && "" != bds.comm.user && setTimeout(function () {
            $.ajax({
                dataType: "script",
                cache: !0,
                url: (bds.su && bds.su.urStatic
                    ? bds.su.urStatic
                    : "http://ss.bdimg.com") + "/static/message/js/mt_show_1.8.js",
                success: function () {
                    function t() {
                        $("#imsg")[0] && $("#u")[0] && $("#user")[0] && (bds.se.message && bds.se.message.init && bds.se.message.init({button: $("#imsg"), refer: $("#u")}), $("#user").on("mouseover", function () {
                            $("#s_mod_msg").hide()
                        })),
                        $("#imsg1")[0] && $("#u1")[0] && $("#user1")[0] && (bds.se.message && bds.se.message.init && bds.se.message.init({button: $("#imsg1"), refer: $("#u1")}), $("#user1").on("mouseover", function () {
                            $("#s_mod_msg").hide()
                        }))
                    }
                    function e() {
                        bds.se.message && bds.se.message.addStyle && bds
                            .se
                            .message
                            .addStyle()
                    }
    ...
    $(window).on("swap_end", function () {
        var t = '<div id="_FP_userDataDiv" style="behavior:url(#default#userdata);width:0px;heigh' +
                    't:0px;position:absolute;top:-1000px;left:-1000px"></div><div id="_FP_comDiv" sty' +
                    'le="behavior:url(#default#clientCaps);width:0px;height:0px;position:absolute;top' +
                    ':-1000px;left:-1000px"></div>',
        ...
        if (u && (d = !0, c = u[1]), !(d && c >= 39)) {
            ...
            var m = function (t) {
                ...
                var r = $.getCookie("BAIDUID"),
                    ...
                    c = bds && bds.util && bds.util.domain
                        ? bds
                            .util
                            .domain
                            .get("http://eclick.baidu.com/ps_fp.htm?")
                        : "http://eclick.baidu.com/ps_fp.htm?",
                    d = c + "pid=ps&fp=" + t.data.fp + "&im=" + t.data.im + "&wf=" + t.data.wf + "&br=" + t.data.br + "&qid=" + e + "&bi=" + r + "&psid=" + s;
                o.src = d
            };
            return window._FPID_CACHE
                ? void(window._FPIDTimer = window.setTimeout(function () {
    ...
    bds
        ...
        .set(function () {
            function t() {
                return o.indexOf("lbbrowser") > 0
                    ? o.match(/lbbrowser/gi)
                    : o.indexOf("maxthon") > 0
                        ? o.match(/maxthon\/[\d.]+/gi)
                        : o.indexOf("bidubrowser") > 0
                            ? o.match(/bidubrowser/gi)
                            : o.indexOf("baiduclient") > 0
                                ? o.match(/baiduclient/gi)
                                : o.indexOf("metasr") > 0
                                    ? o.match(/metasr/gi)
                                    : o.indexOf("qqbrowser") > 0
                                        ? o.match(/qqbrowser/gi)
                                        : !function () {
                                            if (navigator.mimeTypes.length > 0) {
                                                var t;
                                                for (t in navigator.mimeTypes) 
                                                    if ("application/vnd.chromium.remoting-viewer" == navigator.mimeTypes[t].type) 
                                                        return !0
                                            }
                                            return !1
                                            ...
                                            : o.indexOf("msie") > 0
                                                ...
                                                : window.document.documentMode
                                                    ...
                                                    : o.indexOf("edge") > 0
                                                        ? o.match(/edge\/[\d.]+/gi)
                                                        : o.indexOf("firefox") > 0
                                                            ? o.match(/firefox\/[\d.]+/gi)
                                                            : o.indexOf("opr") > 0
                                                                ? o.match(/opr\/[\d.]+/gi)
                                                                : o.indexOf("chrome") > 0
                                                                    ? o.match(/chrome\/[\d.]+/gi)
                                                                    : o.indexOf("safari") > 0 && o.indexOf("chrome") < 0
                                                                        ? o.match(/safari\/[\d.]+/gi)
                                                                        : ""
            }
            function e() {
                            ...
                            : n.indexOf("MSIE 7") > 0
                                ...
                                : n.indexOf("MSIE 8") > 0
                                    ...
                                    : n.indexOf("MSIE 9") > 0
                                        ...
                                        : n.indexOf("MSIE 10") > 0
                                            ? "ie10"
                                            : "11" == window.document.documentMode
                                                ? "ie11"
                                                : "other"
                    : ""
            }(),
            browsertype = function () {
                return o.indexOf("msie") > 0 || new RegExp("trident(.*)rv.(\\d+)\\.(\\d+)").test(o)
                    ? "ie"
                    : o.indexOf("firefox") > 0
                        ? "firefox"
                        : o.indexOf("chrome") > 0
            ...
            osversion = function () {
                return "windows" == os
                    ? n.indexOf("Windows NT 5.1") > -1 || n.indexOf("Windows XP") > -1
                        ? "xp"
                        : (isWinVista = n.indexOf("Windows NT 6.0") > -1 || n.indexOf("Windows Vista") > -1)
                            ? "vista"
                            : n.indexOf("Windows NT 6.1") > -1 || n.indexOf("Windows 7") > -1
                                ? "win7"
                                : n.indexOf("Windows NT 6.2") > -1 || n.indexOf("Windows 8") > -1
                                    ? "win8"
                                    : n.indexOf("Windows NT 6.3") > -1 || n.indexOf("Windows 8.1") > -1
                                        ? "win8.1"
    ...
    bds.se.heightControl = {
        ...
        cleanRes: function () {
            ...
            if (0 == n) {
                var o = $(t[0]).parent();
                $("#content_right").height() + t.height() < $("#content_left").height() && o.css({position: "static"})
            } else 
    ...
    !function () {
        function t() {
            ...
            this.hostAddr = [
                bds && bds.comm && bds.comm.ubsurl
                    ? bds.comm.ubsurl + "?"
                    : "",
                (bds && bds.util && bds.util.domain
                    ? bds.util.domain.get("http://nsclick.baidu.com")
                    : "http://nsclick.baidu.com") + "/v.gif?",
                (bds && bds.util && bds.util.domain
                    ? bds.util.domain.get("http://sestat.baidu.com")
                    : "http://sestat.baidu.com") + "/wb.gif?"
            ],
            this.commLog = {},
            this.isFirst = !0,
            this.sendNum = {},
        ...
        t.prototype = {
            setCommLog: function (t, e, n) {
                ...
                if (!(t in this.commLog)) {
                    ...
                    e && n
                        ? (o.log = e, o.len = n)
                        : (o.log = "&q=" + bds.comm.queryEnc + "&qid=" + bds.comm.qid + "&rsv_did=" + bds.comm.did + "&rsv_tn=" + bds.comm.tn + "&rsv_sid=" + bds.comm.sid, o.len = (o.log + "&t=" + (new Date).getTime()).length),
                    this.commLog[t] = o
                }
                return !0
            },
            fb: function () {
                var t,
                    e = this.heartTime.length;
                return t = 0 === e || 1 === e
                    ? 3e3
                    : this.heartTime[e - 1] + this.heartTime[e - 2],
                this
                    .heartTime
                    .push(t),
                t
            ...
            collectPoint: function (t, e) {
                ...
                if (0 === r[t].length) {
                    ...
                    if (s.length < 2) 
                        return;
                    return void r[t].push([
                        (new Date).getTime() - r.start,
                        s[0],
                        s[1]
                    ])
                }
            ...
            getData: function (t, e, n) {
                ...
                var o = {
                    ...
                    r = n;
                void 0 === i
                    ? (i = 0, r = t[t.length - 1][0])
                    : void 0 !== i && "number" == typeof i && void 0 === r
                        ? (i -= this.start, r = t[t.length - 1][0])
                        : void 0 !== i && "number" == typeof i && void 0 !== r && "number" == typeof r
                            ? (i -= this.start, r -= this.start)
                            : (i = 0, r = 0);
                for (var s in t) 
                    if (!(t[s][0] < i) && (t[s][0] < r && o.record.push(t[s]),
                    t[s][0] >= r)) 
                        break;
            return o
            },
            send: function (t, e, n) {
                ...
                if ("object" == typeof t) {
                    ...
                    "string" == typeof t && (i = t);
                if (!n && bds && bds.comm && bds.comm.qid && (n = bds.comm.qid), !(n && n in this.commLog)) 
                    return !1;
                if (i += this.commLog[n].log, i += "&t=" + (new Date).getTime(), ("number" != typeof e || 0 > e || e >= this.hostAddr.length) && (e = 0), r = this.hostAddr[e] + i, r.length > this.MAX_LEN) 
                    return !1;
            ...
            sendNow: function (t, e, n) {
                if (t && "string" == typeof t && t in this.keyMap && e) {
                    ...
                    n && n.qid && n.log && n.len
                        ? (this.setCommLog(n.qid, n.log, n), this.send(o, this.keyMap[t], n.qid))
                        : send(o, this.keyMap[t])
                }
            },
            pushData: function (t, e, n) {
                var o = bds && bds.comm && bds.comm.qid
                    ? bds.comm.qid
                    : "";
                if (!o) 
                    return !1;
                n && n.qid && n.log && n.len
                    ? (this.setCommLog(n.qid, n.log, n.len), o = n.qid)
                    : this.setCommLog(o),
                ...
                n && n.level === !0
                    ? i[t][0].push(encodeURIComponent($.stringify(e)))
                    : i[t][1].push(encodeURIComponent($.stringify(e)))
            },
            fetchData: function (t, e) {
                function n() {
                    for (var e, n = 0, o = [], r = !1, d = this.commLog[l].len, m = this.hostAddr[a].length, p = m + ("type=" + t + "&fm=" + u + "&data=").length + d, f = p + 6, h = f; 0 !== i.length && n < this.MAX_SEND;) 
                        c === !1 && 0 === t && n++,
                        e = i.shift(),
                        o.push(e),
                        h = f + e.length + 3,
                ...
                for (var l in r) {
                    ...
                    o = r[l];
                    for (var u in o) 
                        u in this.keyMap && (a = this.keyMap[u], "number" == typeof a && void 0 !== this.hostAddr[a] && (i = o[u][0].length > 0
                            ? o[u][0]
                            : o[u][1],
                        n.call(this),
                        (c === !0 || e !== !0) && 0 === i.length && o[u][1].length > 0 && (i = o[u][1], n.call(this)),
                        c === !0 && delete this.dataStore[l]))
                }
                return s
            },
                ...
                var n,
                    ...
                    s = setInterval(function () {
                        return t.length <= 0
                            ...
                            : (n = t.shift(), void(n && n.qid && n.qid in i.commLog && (o = "type=" + n.type + "&fm=" + n.key + "&data=" + n.data, i.send(o, n.host, n.qid), n.qid in i.sendNum && (i.sendNum[n.qid] += 1))))
                    }, r)
            },
            startCycle: function () {
                var t = this;
    ...
    $(window).on("swap_end", function () {
        ...
        bds.comm.encTn && $.setCookie("H_PS_645EC", bds.comm.encTn, {expires: 2592e3}),
        bds.se.trust && bds
            .se
            .trust
            .init(),
        ...
        bds.comm.feedback
            ? t()
                ? $(document).delegate(".feedback", "click", function () {
                    var t = this;
                    $.getScript("https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/" +
                            "plugins/feedback_67607cd.js",
                    function () {
    ...
    !function () {
        $(window)
            .one("swap_end", function () {
                $("body")
                    .on("mousedown", ".se_common_hint a", function () {
                        var t = $(this),
    ...
    $.ajax({
        ...
        cache: !0,
        url: "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/" +
                "home/js/nu_instant_search_08089ad.js"
    }),
    window.PRE_CONN = function () {
        var t,
            e = function (t, e) {
                var n = 1 * new Date;
                t = bds.util.domain && bds.util.domain.get
                    ? bds
                        .util
                        .domain
                        .get(t)
                ...
                try {
                    window.pageState && 0 != window.pageState && 1 != n || ($("#kw1,#kw").one("keydown", function () {
                        "https:" === location.protocol
                            ? (e("https://ss0.baidu.com/6ONWsjip0QIZ8tyhnq/ps_default.gif"), e("https://ss1.baidu.com/6ONWsjip0QIZ8tyhnq/ps_default.gif"), e("https://ss2.baidu.com/6ONWsjip0QIZ8tyhnq/ps_default.gif"), e("https://ss3.baidu.com/6ONWsjip0QIZ8tyhnq/ps_default.gif"))
                            : (e("http://b1.bdstatic.com/img/pc.gif", parseInt(1e3 * Math.random())), e("http://ecmb.bdimg.com/public03/pc.gif"), $.each([
                                "i7",
                                "i8",
                                "i9",
                                "t10",
                    ...
                    t.mimeType && r.overrideMimeType && r.overrideMimeType(t.mimeType),
                        ...
                        e = function (n, i) {
                            var s,
                                a,
                                c;
                            if (3 !== r.readyState && 4 !== r.readyState || i || !function () {
                                var e = t.delimiter,
                                    n = "";
                                try {
                                    n = r.responseText
                                ...
                                if ("" != n) {
                                    ...
                                    if (e) 
                                        for (;;) {
                                            for (; c <= t.__partsIndex && (i = -1 == a
                                                ? 0
                                                : a + e.length, a = n.indexOf(e, i), -1 != a); c++) 
                                            ;
                                            if (-1 == a && 4 !== r.readyState) 
                                                return;
                                            for (s = 0; s < t.__partsCallback.length; s++) 
                                                t.__partsCallback[s].call(r, n.substring(i, -1 == a
                                                    ? n.length
                                                    : a), t.__partsIndex, n);
                                            if (t.__partsIndex++, -1 == a) 
                                                return
                                        } else 
                                            for (c = 0; c < t.__partsCallback.length; c++) 
                                                t.__partsCallback[c].call(r, n)
                                }
                            }(),
                            e && (i || 4 === r.readyState)) 
                                if (e = void 0, r.onreadystatechange = jQuery.noop, i) 
    ...
    !function () {
        function save(t) {
            ...
            for (tmpName in options) 
                options.hasOwnProperty(tmpName) && "duRobotState" !== tmpName && e.push('"' + tmpName + '":"' + options[tmpName] + '"');
            var n = "{" + e.join(",") + "}";
        ...
        function writeBAIDUID() {
            ...
            Cookie.set("BAIDUID", o.replace(/:.*$/, "") + ("undefined" != typeof n
                ? ":SL=" + n
                : "") + ("undefined" != typeof t
                ? ":NR=" + t
                : "") + ("undefined" != typeof e
                ? ":FG=" + e
                : ""), ".baidu.com", "/", expire30y, !0)
        }
        ...
        try {
            if (bds && bds.comm && bds.comm.personalData) {
                if ("string" == typeof bds.comm.personalData && (bds.comm.personalData = eval("(" + bds.comm.personalData + ")")), !bds.comm.personalData) 
                    return;
                for (tmpName in bds.comm.personalData) 
                    defaultOptions.hasOwnProperty(tmpName) && bds.comm.personalData.hasOwnProperty(tmpName) && "SUCCESS" == bds.comm.personalData[tmpName].ErrMsg && (options[tmpName] = bds.comm.personalData[tmpName].value)
            }
            try {
            ...
            writeCookie(),
            "sugSet" in options || (options.sugSet = 3 != Cookie.get("sug", 3)
                ? 0
                : 1),
            "sugStoreSet" in options || (options.sugStoreSet = Cookie.get("sugstore", 0));
            var BAIDUID = Cookie.get("BAIDUID");
            "resultNum" in options || (options.resultNum = /NR=(\d+)/.test(BAIDUID) && RegExp.$1
                ? parseInt(RegExp.$1)
                : 10),
            "resultLang" in options || (options.resultLang = /SL=(\d+)/.test(BAIDUID) && RegExp.$1
                ? parseInt(RegExp.$1)
                : 0),
            "isSwitch" in options || (options.isSwitch = 2 == Cookie.get("ORIGIN", 0)
                ? 0
                : 1 == Cookie.get("ORIGIN", 0)
                    ? 2
                    : 1),
    ...
    if (window._is_skin_sam && !ie6) {
        var url = "";
        "1" == window._is_skin_sam
            ? url = "../../skin/js/skin_1.js"
            : "2" == window._is_skin_sam
                ? url = "../../skin/js/skin_2.js"
                : "3" == window._is_skin_sam && (url = "../../skin/js/skin_3.js");
        var skinDefer = null;
        if (url) 
            var skinDefer = $.ajax({
                dataType: "script",
    ...
    !function () {
        var t = {},
            ...
            n = function (n, o) {
                var i = Math.random();
                i > .2 && .201 > i && "http:" == location.protocol && (t.url = n, t.headers = o, $.ajax({url: n, headers: o, success: e}))
            },
            o = function (e) {
                if ("string" == typeof e && "object" == typeof t.headers) {
                    if (t.headers.hasOwnProperty("content_syni") && 12495 !== e.length) 
                        return e;
                    if (t.headers.hasOwnProperty("content_syns") && 19295 !== e.length) 
                        return e
                }
                return "normal"
            },
    ...
    bds.se.speedMonitor = function (t) {
        ...
        function n(t) {
            ...
            for (key in t.logData) 
                o.push(key + "=" + encodeURIComponent(t.logData[key]));
            bds
                .se
                .speedTester
                .start(e, l + "&" + o.join("&"), n)
            ...
            _create_elem: function () {
                var t = this.form,
                    ...
                    a = $('<a href="javascript:;"></a>')
                        .attr("id", r)
                        .attr("title", "清空")
                        .addClass("quickdelete");
                s
                    .addClass("quickdelete-wrap")
                    .append(a),
                a.css({
                    top: n + "px",
                    right: o + "px",
    ...
    window.bds && bds.comm && bds.comm.ishome && $(window).on("load", function () {
            ...
            var t = function () {
                ...
                o = function () {
                    ...
                    var r = "//www.baidu.com/nocache/fesplg/s.gif?log_type=hm&type=timing&",
                        s = "";
                    s += n.join("&"),
                    s += "&newindex=" + (window.bds && bds.comm
                        ? bds.comm.newindex
                        : -1),
                    e && (s += "&bsi=" + e);
                    var a = r + s,
    ...
    $(document).delegate(".head_nums_cont_outer", "mousedown", function () {
        if ("undefined" != typeof bds.comm.search_tool) {
            ...
            n.on("click", function () {
                o
                    .animate({
                        ...
                        "en" == bds.comm.search_tool.sl_lang || bds.comm.search_tool.st || bds.comm.search_tool.et || bds.comm.search_tool.si || bds.comm.search_tool.ft || bds.comm.search_tool.exact
                            ? (ns_c({fm: "advTool", qid: bds.comm.qid, title: encodeURI("清除"), rsv_advTool: 2}), baseChangeUrl("wd=" + encodeURIComponent($("#kw").val().replace(/(filetype:[^\s]* )|(site:[^\s]*)/g, "").replace(/^\"+(.+)\"+$/, "$1")) + "&sl_lang=cn&rsv_srlang=cn&rsv_rq=cn&ct=0&si=&tfflag=0&gpc=" + encodeURIComponent("stf=")), $("input[name='gpc'],input[name='si'],input[name='ct']", "form").val(""))
            ...
            if (i.length > 0) {
                ...
                "en" == bds.comm.search_tool.sl_lang
                    ? (r += "<li><a href='javascript:;' onClick='langChangeUrl(\"sl_lang\",\"cn\",this.innerH" +
                            "TML)'>所有网页</a></li>",
                    r += "<li><span>英文网页</span></li>")
                    : "cn" == bds.comm.search_tool.sl_lang && (r += "<li><span>所有网页</span></li>", r += "<li><a href='javascript:;' onClick='langChangeUrl(\"sl_lang\",\"en\",this.innerH" +
                            "TML)'>英文网页</a></li>"),
                r += "</li></ul></div>",
                langfilterTip = new bds
                    .se
                    .tip({
                        target: i,
                        mode: "none",
            ...
            if (s.length > 0) {
                ...
                a += bds.comm.search_tool.st || bds.comm.search_tool.et
                    ? " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf\",this.innerHTML" +
                        ",0)'>时间不限</a></li>"
                    : " <li><span>时间不限</span></li>",
                a += bds.comm.search_tool.st >= bds.comm.search_tool.thisDay && "1" == bds.comm.search_tool.stftype
                    ? " <li><span>一天内</span></li>"
                    : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneDay + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,1)'>一天内</a></li>",
                a += bds.comm.search_tool.st >= bds.comm.search_tool.thisWeek && bds.comm.search_tool.st < bds.comm.search_tool.thisDay && "1" == bds.comm.search_tool.stftype
                    ? " <li><span>一周内</span></li>"
                    : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneWeek + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,2)'>一周内</a></li>",
                a += bds.comm.search_tool.st >= bds.comm.search_tool.thisMonth && bds.comm.search_tool.st < bds.comm.search_tool.thisWeek && "1" == bds.comm.search_tool.stftype
                    ? " <li><span>一月内</span></li>"
                    : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneMonth + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,3)'>一月内</a></li>",
                a += bds.comm.search_tool.st >= bds.comm.search_tool.thisYear && bds.comm.search_tool.st < bds.comm.search_tool.thisMonth && "1" == bds.comm.search_tool.stftype
                    ? " <li><span>一年内</span></li>"
                    : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneYear + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,4)'>一年内</a></li>",
                ...
                a += bds.comm.search_tool.st && bds.comm.search_tool.et && "2" == bds.comm.search_tool.stftype
                    ? "value='" + formatDate(1e3 * bds.comm.search_tool.st, "-") + "' data-value='" + 1e3 * bds.comm.search_tool.st + "' class='c-tip-custom-input'/></p>"
                    : "value='" + formatDate(1e3 * bds.comm.serverTime, "-") + "' data-value='' class='c-tip-custom-input c-tip-custom-input-init'/></p>",
                ...
                a += bds.comm.search_tool.st && bds.comm.search_tool.et && "2" == bds.comm.search_tool.stftype
                    ? "value='" + formatDate(1e3 * bds.comm.search_tool.et, "-") + "' data-value='" + 1e3 * bds.comm.search_tool.et + "' class='c-tip-custom-input'/></p>"
                    : "value='" + formatDate(1e3 * bds.comm.serverTime, "-") + "' data-value='' class='c-tip-custom-input c-tip-custom-input-init'/></p>",
                ...
                timefilterTip = new bds
                    ...
                    .tip({
                        ...
                        onShow: function () {
                            ...
                            $(".c-tip-custom-input").on("click", function (t) {
                                var e = this,
                                    n = null,
                                    o = new Date,
                                ...
                                $(e)
                                    .parents(".c-tip-custom")
                                    .find(".c-tip-custom-input")
                                    .removeClass("c-tip-custom-input-focus"),
                                $(e).addClass("c-tip-custom-input-focus"),
                                0 == $("#c-tip-custom-calenderCont").length && $(e)
                                    .parents(".c-tip-custom")
                                    .append("<div id='c-tip-custom-calenderCont'></div>"),
                                ...
                                var a = {
                                    ...
                                    onSelectDay: function (t) {
                                        ...
                                        $(e)
                                            .removeClass("c-tip-custom-input-focus")
                                            .removeClass("c-tip-custom-input-init")
                                    }
                                };
                                "undefined" == typeof WCal
                                    ? $.getScript("https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/" +
                                            "plugins/new_wcal_3426010.js",
                                    function () {
                                        n = new WCal(a),
                                        o && n.setDay(formatDate(o), function (t) {
                                            t.className += " op_mon_day_selected"
                                        })
                                    })
                                    : (n = new WCal(a), o && n.setDay(formatDate(o), function (t) {
                                        t.className += " op_mon_day_selected"
                                    })),
                            ...
                            $(".c-tip-custom-input").on("blur", function () {
                                ...
                                var e = this,
                                    n = t($(e).val());
                                n instanceof Date && n.getTime()
                                    ? ($(e).attr("data-value", n.getTime()), $(".c-tip-timerfilter-custom-error").hide())
                                    : "" == $(e).val()
                                        ? ($(e).attr("data-value", "0"), $(".c-tip-timerfilter-custom-error").hide())
                                        : ($(e).attr("data-value", ""), $(".c-tip-timerfilter-custom-error").show())
                            });
                            try {
                                $(".c-tip-custom-submit")
                                    .off("click.searchTool")
                                    .on("click.searchTool", function (t) {
                                        var e = this,
                                        ...
                                        i > bds.comm.serverTime && (0 >= o
                                            ? (o = "", i = "")
                                            : i = parseInt((new Date).setHours(23, 59, 58) / 1e3)),
                                        o > i || o > bds.comm.serverTime
                                            ? ($(".c-tip-timerfilter-custom-error").show(), void t.stopPropagation())
                                            : (0 == o && 0 == i && (o = "", i = ""), $(".c-tip-timerfilter-custom-error").hide(), void advChangeUrl("gpc", "stf=" + o + "," + i + "|stftype=2", "自定义时间:" + o + "|" + i, 5))
                                    })
                            } catch (t) {}
                        }
                    }),
            ...
            if (c.length > 0) {
                ...
                d += bds.comm.search_tool.ft
                    ? " <li><a href='javascript:;' onClick='fileChangeUrl(null,this.innerHTML,0)'>所有网页和" +
                        "文件(不限格式)</a></li>"
                    : " <li><span>所有网页和文件(不限格式)</span></li>",
                d += "pdf" == bds.comm.search_tool.ft
                    ? " <li><span>Adobe Acrobat PDF(.pdf)</span></li>"
                    : " <li><a href='javascript:;' onClick='fileChangeUrl(\"pdf\",this.innerHTML,1)'>Ad" +
                        "obe Acrobat PDF(.pdf)</a></li>",
                d += "doc" == bds.comm.search_tool.ft
                    ? " <li><span>微软 Word(.doc)</span></li>"
                    : " <li><a href='javascript:;' onClick='fileChangeUrl(\"doc\",this.innerHTML,2)'>微软" +
                        " Word(.doc)</a></li>",
                d += "xls" == bds.comm.search_tool.ft
                    ? " <li><span>微软 Excel(.xls)</span></li>"
                    : " <li><a href='javascript:;' onClick='fileChangeUrl(\"xls\",this.innerHTML,3)'>微软" +
                        " Excel(.xls)</a></li>",
                d += "ppt" == bds.comm.search_tool.ft
                    ? " <li><span>微软 PowerPoint(.ppt)</span></li>"
                    : " <li><a href='javascript:;' onClick='fileChangeUrl(\"ppt\",this.innerHTML,4)'>微软" +
                        " PowerPoint(.ppt)</a></li>",
                d += "rtf" == bds.comm.search_tool.ft
                    ? " <li><span>RTF 文件(.rtf)</span></li>"
                    : " <li><a href='javascript:;' onClick='fileChangeUrl(\"rtf\",this.innerHTML,5)'>RT" +
                        "F 文件(.rtf)</a></li>",
                d += "</ul></div>";
                var l = new bds
                    .se
            ...
            u.length > 0 && (insideSearchTip = new bds.se.tip({
                target: u,
                mode: "none",
                content: $("<div class='c-tip-menu c-tip-timerfilter c-tip-timerfilter-si'><ul> <li><input n" +
                        "ame='si' type='txt' class='c-tip-si-input c-gap-bottom-small c-gap-right-small' " +
                        "autocomplete='off' value='" + bds.comm.search_tool.si + "' placeholder='例如:baidu.com' /><a href='javascript:;' class='c-tip-timerfilter-s" +
                        "i-submit'>确认</a></li> <li><p class='c-tip-timerfilter-si-error'>无法识别，正确格式：baidu." +
                        "com</p></li></ul></div>"),
                arrow: {
                    has: 0,
                    offset: 0
                        ...
                        $(".c-tip-timerfilter-si-submit")
                            ...
                            .on("click.searchTool", function (t) {
                                ...
                                if ("" == o) 
                                    ...
                                    if (!o.match(/^[\w\-_]+(\.[\w\-_]+)+$/)) 
                                        return $(".c-tip-timerfilter-si-error").show(),
                                        t.stopPropagation(),
                                        t.preventDefault(),
                                        !1;
            ...
            i.on("click", function (t) {
                m
                    ? (langfilterTip && langfilterTip.show(), m = !1, timefilterTip && timefilterTip.hide(), p = !0, l && l.hide(), f = !0, insideSearchTip && insideSearchTip.hide(), h = !0, ns_c({fm: "advTool", qid: bds.comm.qid, title: encodeURI("语言筛选浮层展现"), rsv_advTool_tip: 1}), $(document).on("click.searchTool", function (t) {
                        0 == $(t.target)
                            .parents(".c-tip-langfilter")
                            .length && langfilterTip && (langfilterTip.hide(), m = !0, $(document).off("click.searchTool"))
                    }))
            ...
            s.on("click", function (t) {
                p
                    ? (langfilterTip && langfilterTip.hide(), m = !0, timefilterTip && timefilterTip.show(), p = !1, l && l.hide(), f = !0, insideSearchTip && insideSearchTip.hide(), h = !0, ns_c({fm: "advTool", qid: bds.comm.qid, title: encodeURI("时间筛选浮层展现"), rsv_advTool_tip: 0}), $(document).on("click.searchTool", function (t) {
                        0 == $(t.target)
                            .parents(".c-tips-container,#c-tip-custom-calenderCont")
                            .length && timefilterTip && (timefilterTip.hide(), $("#c-tip-custom-calenderCont").hide(), timefilterTip.getDom().find(".c-tip-custom-input-focus").removeClass("c-tip-custom-input-focus"), p = !0, $(document).off("click.searchTool"))
                    }))
            ...
            c.on("click", function (t) {
                f
                    ? (langfilterTip && langfilterTip.hide(), m = !0, timefilterTip && timefilterTip.hide(), p = !0, l && l.show(), f = !1, insideSearchTip && insideSearchTip.hide(), h = !0, ns_c({fm: "advTool", qid: bds.comm.qid, title: encodeURI("网页格式浮层展现"), rsv_advTool_tip: 2}), $(document).on("click.searchTool", function (t) {
                        0 == $(t.target)
                            .parents(".c-tip-timerfilter-ft")
                            .length && l && (l.hide(), f = !0, $(document).off("click.searchTool"))
                    }))
            ...
            u.on("click", function (t) {
                h
                    ? (langfilterTip && langfilterTip.hide(), m = !0, timefilterTip && timefilterTip.hide(), p = !0, l && l.hide(), f = !0, insideSearchTip && insideSearchTip.show(), h = !1, ns_c({fm: "advTool", qid: bds.comm.qid, title: encodeURI("站内搜索浮层展现"), rsv_advTool_tip: 3}), $(document).on("click.searchTool", function (t) {
                        0 == $(t.target)
                            .parents(".c-tip-timerfilter-si")
                            .length && insideSearchTip && (insideSearchTip.hide(), h = !0, $(document).off("click.searchTool"))
                    }))
        ...
        function t() {
            function t(t, e) {
                var n = {
                    ...
                    r = t + (i.p5 || "");
                return {id: r, pos: n, size: o, dataClick: i, dom: e}
            }
            var e = {},
                n = {},
                o = $("#wrapper");
            return e.topResult = o
                .find("#con-at")
                .find(".result-op"),
            e.rightResult = o
                .find("#con-ar")
    ...
    !function () {
        ...
        t.prototype = {
            ...
            getResult: function (t) {
                for (var e = this, n = t, o = 0, i = Math.min(n.length, 10); i > o; o++) {
                    var r = n[o].id,
            ...
            getResultDisplay: function (t) {
                ...
                function o() {
                    return d.rsv_bdr && 0 != d.rsv_bdr
                        ? d.rsv_bdr
                        : c.hasClass(".c-border") || c
                            .find(".c-border")
                            .length
                            ? 5
                            : 0
                ...
                function r() {
                    ...
                    return t.each(function () {
                        ...
                        if (t && n.test(t)) {
                            ...
                            e.push(i && i.length && i.length > 0 && i[1]
                                ? i[1]
                                : t)
                        } else 
                            t && o.test(t) && e.push(t)
                ...
                function a() {
                    ...
                    return e.length
                        ? (e.each(function () {
                            var e = $(this),
                                n = {};
                            n.type = e.is("object") && e.attr("type") && e
                                .attr("type")
                                .indexOf("flash") >= 0
                                ? 1
                                : e.is("video")
                ...
                var c = t.dom,
                    d = t.dataClick,
                    l = {};
                if (l.id = d.p5 || "", l.srcid = d.rsv_srcid || c.attr("srcid") || 0, l.tpl = c.attr("tpl") || "", l.mu = d.mu || c.attr("mu") || "", l.fm = d.fm || "as", c.is(":hidden") && (l.show = 0), 0 == l.show) 
                    return l;
                l.size = e(),
                l.pos = n(),
                o() && (l.bdr = o()),
                ...
                var u = r(),
                    m = s(),
                    p = a();
                return (u || m || p) && (l.expand = {}, u && (l.link = u.length, l.expand.links = u), m && (l.img = m.length, l.expand.imgs = m), p && (l.app = p.length, l.expand.apps = p)),
                l
            }
        }
    }(),
    !function () {
        ...
        t.prototype = {
            ...
            sendLog: function (t, e) {
                bds.comm.globalLogFlag && 1 == bds.comm.globalLogFlag && bds
                    .log
                    .send
                    .sendPack(t, e)
            },
            bindEvent: function (t) {
                ...
                $.each(t, function (t, n) {
                    ...
                    n
                        .dom
                        .bind("mouseenter.useraction", function () {
            ...
            destroy: function () {
                ...
                this
                    .pageElementsList
                    .splice(0, this.pageElementsList.length)
            },
            sight: function () {
                var t = this;
    ...
    bds.se.recommend.prototype = {
        ...
        dispose: function () {
            ...
            bds.se.recommend.prototype.recommDom && bds
                .se
                .recommend
                .prototype
                .recommDom
                .remove(),
            bds.se.recommend.prototype.cssDom && bds
                .se
                .recommend
                .prototype
                .cssDom
        ...
        resetArrow: function () {
            ...
            t
                .op
                .arrowDom
                .css({right: t.op.arrowOffset_s})
                .removeClass("rrecom-btn-click rrecom-btn-moving")
                .find(".rrecom-btn")
                .stop()
                .hide()
                .removeClass("rrecom-btn-hover")
        },
        setArrowPos: function () {
            var t = this;
            t.currInstance && ("l" === bds.comm.containerSize
                ? t.currInstance.op.arrowDom.css("right", t.op.arrowOffset_l)
                : t.currInstance.op.arrowDom.css("right", t.op.arrowOffset_s))
        },
        moveArrow: function (t) {
            ...
            n.right = "l" === bds.comm.containerSize
                ? e.op.arrowOffset_l
                : e.op.arrowOffset_s,
            e
                .op
                .arrowDom
                .stop()
                .addClass("rrecom-btn-moving rrecom-btn-click")
                .animate(n, 0, function () {
                    e.currInstance && e.currInstance !== e && e
                        .currInstance
                        .resetArrow(),
                    t()
                })
        ...
        log: function (t) {
            ...
            var m = this
                ...
                .find(".t>a")
                .eq(0);
            return e.rsv_re_fcurl = m.length
                ? m.attr("href")
                : r,
        ...
        getJsonp: function (t) {
            ...
            if (o && o.length && o.length > 0 && o[1]) {
                ...
                var r = "http://lcr.open.baidu.com/link?url=" + encodeURIComponent(n) + "&query=" + encodeURIComponent(i),
                    s = window.bds && bds.util && bds.util.domain && bds
                        .util
                        .domain
                        .get(r);
                return $.ajax({
        ...
        getRemoteData: function (t) {
            ...
            $
                .when(this.getJsonp(n))
                .then(function (n) {
                    n && n.data && n.data.length && n.data[0]
                        ? (n.data[0].hintData && e.asynClkRcmd(n.data[0].hintData), (n.data[0].extData || n.data[0].tplData) && (e.setCacheData(n.data), t()))
                        : e.setCacheData("[NO DATA]")
                }, function () {})
        },
        asynClkRcmd: function (t) {
            ...
            if (t && t.linkInfo) {
                ...
                if (t.defaultHide, i && i.length && (i.remove(), o.append(e.buildRcmdDom(t))), !o || !o.length) {
                    var s = $('<div class="c-gap-top c-recommend"><i class="c-icon c-icon-bear-circle c-gap-rig' +
                            'ht-small"></i><span class="c-gray">' + r + "</span></div>");
                    n
                        .find(".c-recommend")
                        .hide(),
        ...
        buildRcmdDom: function (t) {
            for (var e = this, n = "", o = t.linkInfo, i = 0, r = o.length; r > i; i++) {
                var s = o[i].txt,
                    a = o[i].wd,
                    c = o[i].sa,
                    d = "c-gap-left-large";
        ...
        buildURL: function (t) {
            ...
            n.rsv_idx = i.length
                ...
                : "";
            for (var s in n) 
                n.hasOwnProperty(s) && n[s] && (r += s + "=" + encodeURIComponent(n[s]) + "&");
            return e + r + t
        },
        renderTpl: function (t, e) {
            ...
            if (t && e) {
                ...
                return o.right_recommends_merge = function (t) {
                    function o(e, o) {
                        var i,
                            r = '<div class="cr-content" data-click=\'#{2}\'><div class="cr-title c-clearfix"><sp' +
                                    'an title="#{0}">#{1}</span></div>',
                            s = '<div class="c-row c-gap-top">',
                            a = '<div class="c-span4#{5} rrecom-item" data-click=\'#{6}\'><div class="rrecom-p"><' +
                                    'a target="_blank" href="#{0}"><img class="c-img c-img4 rrecom-img" src="#{1}"></' +
                                    'a></div><div class="c-gap-top-small"><a target="_blank" title="#{2}" href="#{3}"' +
                                    '>#{4}</a></div>',
                            c = "</div>",
                            d = "",
                        ...
                        for (var m = n.op.target.find(".t>a").eq(0), p = m.length
                            ? m.attr("href")
                            : n.op.target.attr("mu"), f = 0, h = e.list.length; h > f; f++) {
                            i = e.list[f];
                            var g = {
                                    rsv_re_ename: i.name,
                                    rsv_re_uri: i.uri,
                            ...
                            d += $.format(a, b, i.img, i.name, b, $.subByte(i.name, 20), (f + 1) % 4 === 0
                                ? " c-span-last rrecom-item-rowLast"
                                : (f + 1) % 4 === 3
                                    ? " rrecom-item-s"
                                    : "", $.stringify(g), i.attrpic),
                            d += c,
                            ((f + 1) % 4 === 0 || f == h - 1) && (d += c)
                        }
                        return d += c,
                    ...
                    for (var a = 0, c = t.card.length; c > a; a++) {
                        var d = t.card[a];
                        if (s += parseInt(d.shownums || 0), s > r) 
                            break;
                        i += o(d, a + 1)
                    }
                    return i
        ...
        render: function (t) {
            for (var e = "", n = 0; n < t.length; n++) 
                e += this.renderTpl(t[n].extData.tplt, t[n].tplData);
            var o = this.getLeftP();
            o.fm = "alxr",
            this
                .recommDom
                .attr("data-click", $.stringify(o))
                .find(".rrecom-content")
                .eq(0)
                .empty()
                .append(e),
        ...
        createRecommDom: function () {
            var t = [
                    '<div style="position:fixed;left:-1px;background:#fff;border:1px solid #eee;z-ind' +
                            'ex:103" class="result-op xpath-log" data-click=\'{"fm":"alxr","p1":1,"p5":1}\'>',
                    '<div class="rrecom-ajax-loading c-loading"></div>',
                    '<div class="rrecom-container">',
                    '<a href="javascript:;" class="rrecom-btn-close" data-click=\'{"rsv_re_fc":4,"fm"' +
                            ':"beha"}\'></a>',
                    '<div class="rrecom-content"></div>',
                    "</div>",
                    "</div>"
                ].join(""),
                e = "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/" +
                        "global/img/rrecom_icon_e34d796.png",
                n = [
                    "<style>", ".rrecom-btn-close,.rrecom-btn span{background:url(" + e + ") no-repeat;}",
                    ".rrecom-btn-close{display:inline-block;width:13px;height:13px;position:absolute;" +
                            "top:26px;right:10px;background-position:0 -20px;}",
                    ".rrecom-btn-parent{z-index:104;position:absolute;right:-37px;top:50%;margin-top:" +
                            "-50px;height:59px;width:40px;cursor:default;padding:20px 0px;}",
                    ".rrecom-btn{display:none;background-color:#fff;padding:20px 5px;position:absolut" +
                            "e;right:10px;width:20px;height:19px;border:1px solid transparent;}",
                    ".rrecom-btn-hover{right:-1px;border:1px solid #eee;border-right:1px solid #fff;z" +
                            "-index:104;box-shadow:0px 2px 0px rgba(0,0,0,0.072);-webkit-box-shadow:0px 2px 0" +
                            "px rgba(0,0,0,0.072);-moz-box-shadow:0px 2px 0px rgba(0,0,0,0.072);-o-box-shadow" +
                            ":0px 2px 0px rgba(0,0,0,0.072);}",
                    ".rrecom-btn span{cursor:pointer;background-position:0 0;width:20px;height:19px;p" +
                            "osition:absolute;top:50%;left:50%;margin:-10px 0 0 -10px;}",
                    ".rrecom-container{width:368px;padding-top:43px;overflow:hidden;background-color:" +
                            "#fff;}",
                    ".rrecom-ajax-loading{position:absolute;left:50%;margin-left:-25px;top:50px;displ" +
                            "ay:none;}",
                    ".rrecom-content{margin-left:17px;}",
                    ".rrecom-content .cr-content{width:100%;margin-bottom:28px;}",
                    ".rrecom_content_s{padding-left:0px;width:276px;}",
                    ".rrecom_content_s .rrecom-item-rowLast{display:none}",
                    ".rrecom_content_s .rrecom-item-s{margin-right:0;}",
                    ".rrecom-panel{text-align:center;}",
                    "</style>"
                ].join("");
            bds.se.recommend.prototype.recommDom = $(t),
            bds.se.recommend.prototype.cssDom = $(n),
            bds.se.recommend.prototype.loadDom = this
                .recommDom
                .find(".rrecom-ajax-loading"),
            this.setRecommSize(),
            $("body")
                .append(this.cssDom)
                .append(this.recommDom.hide()),
            this.bindRecommEvent(),
            $(window).trigger("container_resize.recommend", bds.comm.containerSize);
            var o = $("#foot");
            "static" === o.css("position") && o.css({position: "relative", "z-index": 104})
        },
            ...
            e
                ...
                .each(function () {
                    ...
                    return "div" === this
                        .nodeName
                        .toLowerCase()
                        ? (t = parseInt($(this).css("margin-bottom")), bds.se.recommend.prototype.global.topGap = isNaN(t)
                            ? 0
                            : t, !1)
                        : void 0
                }),
        ...
        setRecommTop: function () {
            ...
            this
                ...
                .css({"margin-top": "0px"}),
            bds.se.recommend.prototype.global.originalTop = t < e.top - n
                ? e.top - n
                : t
        },
        setRecommLeft: function () {
            ...
            "fixed" === this
                .recommDom
                .css("position") && (t = $("#content_right").offset().left, e = $(window).scrollLeft(), this.recommDom.css("left", parseInt(t) - e))
        },
        bindRecommEvent: function () {
            var t = this;
            this
                .recommDom
                .find(".rrecom-btn-close")
                .eq(0)
                .on("click", function () {
                    t.hideRecommDom()
                }),
            $(window).on("scroll.recommend", function () {
                ...
                if (t.recommDom && "none" !== t.recommDom.css("display")) {
                    ...
                    e <= i.top - r
                        ? "fixed" === t
                            .recommDom
                            .css("position") && (t.recommDom.css("position", "absolute"), t.recommDom.css("top", i.top))
                        : "absolute" === t
                            .recommDom
                            .css("position") && (t.recommDom.css("position", "fixed"), t.recommDom.css("top", r));
                    var a = t
                        .recommDom
                        .find(".rrecom-container");
                    t.global.originalTop < e
                        ? (maxMargin = Math.min(t.recommDom.height() - a.height() - 82 - 75, 0), a.css({
                            "margin-top": Math.max(t.global.originalTop - e, maxMargin)
                        }))
                        : a.css({"margin-top": "0px"}),
                    n && (o = $("#content_right").offset().left, "fixed" === t.recommDom.css("position")
                        ? t.recommDom.css("left", parseInt(o) - n)
                        : t.recommDom.css("left", parseInt(o)))
                    }
                })
                ...
                .on("container_resize.recommend", function (e, n) {
                    var o = t
                        .recommDom
                        .find(".rrecom-container");
                    "s" !== n || o.hasClass("rrecom_content_s")
                        ? "l" === n && (o.removeClass("rrecom_content_s"), o.find(".rrecom-content").css("width", t.op.container_l - 17 + "px"))
                        : (o.addClass("rrecom_content_s"), o.find(".rrecom-content").css("width", t.op.container_s - 17 + "px"))
                })
        },
        ...
        showRecommDom: function () {
            ...
            t
                .recommDom
                .find(".rrecom_content_s")
                .length > 0
                ? t
                    .recommDom
                    .find(".rrecom-content")
                    .css("width", t.op.container_s - 17 + "px")
                : t
                    .recommDom
                    .find(".rrecom-content")
                    .css("width", t.op.container_l - 17 + "px"),
    ...
    $(window).one("swap_end", function () {
        bds.comm.upn.ie && 6 == bds.comm.upn.ie || $(document).on("click", "#content_left .result .t>a, #content_left .result-op .t>a, .op-se-listen-recomme" +
                "nd",
        function (t) {
    ...
    $(window).on("swap_begin", function () {
        bds.se.recommend.prototype.currInstance && bds
            .se
            .recommend
            .prototype
            .hideRecommDom(),
    ...
    bds.se.asynAds = function (t) {
        ...
        if (e && o && i && n) {
            ...
            for (var s = [
                ...
                "fenlei",
                "adext"
            ], a = "ie=utf-8&oe=utf-8&dsp=pc", d = 0; d < s.length; d++) {
                var l = s[d];
                t[l] && (a += "&" + l + "=" + t[l])
            }
            var u = bds.comm.orderplay,
                m = "",
                p = function (t) {
                    if (bds && bds.comm && bds.comm.upn && bds.comm.upn.browser && "firefox" == bds.comm.upn.browser) 
                        var e = t.textContent;
                    else 
                        var e = t.innerText;
                    var n = e.indexOf("\n"),
                ...
                success: function (t) {
                    ...
                    if (t && t.results && t.results.length && o.length) {
                        ...
                        $(document).scrollTop() < o
                            .position()
                            .top + o.height() && $(document).scrollTop() + $(window).height() > o
                            .position()
                            .top && c({fm: "inlo", rsv_ad: "ad_asyn_shake"}),
                        r && r()
                    } else 
            ...
            c({fm: "inlo", rsv_ad: "ad_asyn_param_error"})
    },
    !function () {
        function t() {
            d = Math.random()
        ...
        location
            .protocol
            .indexOf("https") > -1 && $(window).on("swap_dom_ready", function () {
            t()
        })
            .on("swap_end", function () {
                e()
    ...
    !function () {
        var t,
            e,
            n = bds && bds.util && bds.util.domain && bds
                .util
                .domain
                .get("http://sensearch.baidu.com/sensearch/selecttext");
        $(window).one("swap_end", function () {
            bds.comm.upn && bds.comm.upn.ie && 6 == bds.comm.upn.ie || $(document).on("mousedown", function (n) {
                t && 0 == $(n.target)
                    .closest(t.getDom())
                    .length && (t.getDom().hide(), e && e.abort())
            })
                .on("mouseup", function (o) {
                    var i,
                        ...
                        a,
                        c;
                    if (!t || !$(o.target).closest(t.getDom()).length) 
                        try {
                            setTimeout(function () {
                                if (window.getSelection) {
                                    if (i = window.getSelection(), 0 == i.rangeCount) 
                                        return;
                                    r = i.getRangeAt(0),
                                    s = r.getBoundingClientRect(),
                                    a = $.trim(i.toString()),
                                    c = $("#text" == r.commonAncestorContainer.nodeName
                                        ? r.commonAncestorContainer.parentNode
                                        : r.commonAncestorContainer)
                                } else 
                                    document.selection && (i = document.selection.createRange(), r = i, s = r.getBoundingClientRect(), a = $.trim(i.text.toString()), c = $(r.parentElement()));
                                    ...
                                    e = $.ajax({
                                        ...
                                        success: function (e) {
                                            ...
                                            if (e && e.data && e.data.type && e.data.to && "zh" == e.data.to && e.data.result && e.data.result.length && e.data.result != a) 
                                                if (1 == e.data.type) 
                                                    for (var o = e.data.result, i = 0, r = Math.min(o.length, 2); r > i; i++) 
                                                        n += (0 == i
                                                            ? ""
                                                            : "<br/>") + (o[i].pre
                                                            ? o[i].pre + "&nbsp;"
                                                            : ""),
                                                        n += o[i].cont
                                                            ? $.subByte(o[i].cont, 46 * (1 == r
                                                                ? 2
                                                                : 1) + 1)
                                                            : "";
                                            else 
                                                2 == e.data.type && (n = '<span style="color:#999">译：</span>' + e.data.result);
                                            if (n) {
                                                t = t || new bds
                                                    .se
                                                    .tip({
                                                ...
                                                var c = t.getDom();
                                                c
                                                    .find(".translateContent")
                                                    .html('<p style="margin:0 8px">' + n + "</p>"),
                                                c.css({
    ...
    !function () {
        function t(t) {
            return t = i(t),
            t.attr("id") || t.attr("data-click") && $
                .parseJSON(t.attr("data-click"))
                .rsv_srcid || t.attr("class") || "-1"
        }
        function e(t) {
            var e = i(t),
                n = e.clone();
            n.unbind(),
            n
                .children(".fb-list-container")
                .remove(),
            n
                .children(".fb-list-container-first")
                .remove(),
            n
                .children(".fb-hint-tip")
                .remove(),
            n.removeAttr("style"),
            n.css("margin", "0"),
            t.append(n),
        ...
        function o() {
            ...
            bds.se.ShortCut.ldialog && bds
                .se
                .ShortCut
                .ldialog
                .destory(),
            bds.se.ShortCut.rdialog && bds
                .se
                .ShortCut
                .rdialog
                .destory(),
        ...
        function i(t) {
            return t.closest(t.closest("#rs").length
                ? "#rs"
                : t.closest("#con-ar").length
                    ? ".result-op"
                    : "#content_left > div")
        }
        function r() {
            ...
            $(".c-container")
                .first()
                .append("<div class='fb-list-container-first' data-html2canvas-ignore='true'></div>"),
            $(".c-container")
                .first()
                .find(".fb-list-container-first")
                .css("width", $(".c-container").first().width() + 20),
            $(".c-container")
                .first()
                .find(".fb-list-container-first")
                .css("height", $(".c-container").first().height() + 10),
            $(".c-container")
                .first()
                .append('<div class="fb-hint-tip" data-html2canvas-ignore="true"><span>鼠标点击，可对单条结果进行反馈</s' +
                        'pan></div>');
            var e = $("#rs");
            e.append("<div class='fb-list-container' data-html2canvas-ignore='true'></div>"),
            e
                .find(".fb-list-container")
                .css("width", e.width() + 20),
            e
                .find(".fb-list-container")
                .css("height", e.height() + 10);
        ...
        function s(t) {
            ...
            e = e + '<div class="fb-select"><div class="fb-select-shorter"><div class="fb-type-select' +
                    'ed">' + t[0].value + '<div class="fb-select-icon"></div></div><div class="fb-type-container">';
            for (var n = 0; n < t.length; n++) 
                e = e + "<div class='fb-type-item' value='" + t[n].key + "'>" + t[n].value + "</div>";
        ...
        function a(t, e) {
            ...
            this.build = function () {
                var t = "",
                    ...
                    n = s(e),
                    o = '<div class="fb-textarea fb-content-block"><textarea maxlength="400" class ="fb-d' +
                            'es-content" name="content" placeholder="请详细说明，以便于我们定位和解决问题，如：内容有误/定位地点不准确等（字数限制在' +
                            '300字以内）"></textarea></div>',
                    i = "",
                    r = "";
                bds.se.ShortCut.uploadImg && (i = '<div class="fb-block fb-cut-block" ><div class="fb-cut-input c-icon c-icon-succe' +
                        'ss"  ></div><span class="fb-shangchuan">包含屏幕截图</span></div>',
                r = '<div class="fb-block fb-canvas-block"><img src=""/><input type="hidden" name="im' +
                        'g_base64" class="fb-img"></div>');
                var a = '<div class="fb-block fb-email-block"><input type="text" class="fb-email"  name="' +
                        'email" maxlength="100" placeholder="联系邮箱（留下联系邮箱，以便我们快速反馈）"></div>';
                t = '<div class="fb-modal "><div class="fb-header" id="fb_dialog_header" unselectable' +
                        '="on" onselectstart="return false;"><a class="fb-close" id="fb_close_x">×</a><h3' +
                        '  class="fb-header-tips">搜索结果反馈</h3></div><div class="fb-body" id="fb_qa_feedbac' +
                        'k_body"><div class="fb-action"><form id="fb_right_post_form" enctype="multipart/' +
                        'form-data" onsubmit = "return false;">' + n + o + i + r + a + '</form> </div><div class="fb-hint fb-hint-no-content"><span>请填写描述反馈</span></div>' +
                        '<div class="fb-hint fb-hint-no-email"><span>请留下您的联系方式</span></div><div class="fb' +
                        '-hint fb-hint-error-email"><span>邮箱格式不正确</span></div><div class="fb-footer"><div' +
                        ' class="fb-btn fb-btn-primary" id="fb_right_post_save">提交反馈</div></div><div clas' +
                        's="fb-guide fb-guide-block"><span><a style="text-decoration:underline;" href="ht' +
                        'tp://ufo.baidu.com/listen/history?type=commonqa#/commonqa" target="_blank">常见解决办' +
                        '法</a></span><span><a style="text-decoration:underline;float:right;margin-right: ' +
                        '-5px;" href="http://ufo.baidu.com/listen/history?type=history#/history" target="' +
                        '_blank">我的反馈</a></span></div></div></div><div class="fb-mask" style="display:non' +
                        'e"  data-html2canvas-ignore="true"></div><div class="fb-success" style="display:' +
                        'none" ><div class="fb-header" id="fb_dialog_header" unselectable="on" onselectst' +
                        'art="return false;"><a class="fb-close" id="fb_close_x">×</a><h3  class="fb-head' +
                        'er-tips">非常感谢</h3></div><div class="fb-body" id="fb_qa_feedback_body"><div class' +
                        '="fb-success-text fb-success-text-title"><i class="c-icon c-icon-right-empty"></' +
                        'i>提交成功</div><div class="fb-success-text">感谢您的宝贵意见</div></div></div>';
            ...
            this.bindEvent = function () {
                ...
                $(this.dom)
                    .find("#fb_right_post_save")
                    .on("click", function () {
                        $(t.dom)
                            .find(".fb-textarea textarea")
                            .val()
                            ? -1 == [27468].indexOf(Number($(t.dom).find(".fb-select-value").val())) || $(t.dom)
                                .find(".fb-email")
                                .val()
                                ? $(t.dom)
                                    .find(".fb-email")
                                    .val() && !/^(\w)+(\.\w+)*@(\w)+((\.\w{2,3}){1,3})$/.test($(t.dom).find(".fb-email").val())
                                    ? ($(t.dom).find(".fb-hint-error-email").css("display", "block"), setTimeout(function () {
                                        $(t.dom)
                                            .find(".fb-hint-error-email")
                                            .css("opacity", "1"),
                                        setTimeout(function () {
                                            $(t.dom)
                                                .find(".fb-hint-error-email")
                            ...
                            : ($(t.dom).find(".fb-hint-no-content").css("display", "block"), setTimeout(function () {
                                    $(t.dom)
                                        .find(".fb-hint-no-content")
                                        .css("opacity", "1"),
                                    setTimeout(function () {
                                        $(t.dom)
                                            .find(".fb-hint-no-content")
                ...
                $(this.dom)
                    ...
                    .on("click", function () {
                        $(t.dom)
                            .find(".fb-cut-input")
                            .hasClass("c-icon")
                            ? ($(t.dom).find(".fb-cut-input").removeClass("c-icon"), $(t.dom).find(".fb-cut-input").removeClass("c-icon-success"), $(t.dom).find(".fb-canvas-block").css("display", "none"))
                            : ($(t.dom).find(".fb-cut-input").addClass("c-icon"), $(t.dom).find(".fb-cut-input").addClass("c-icon-success"), $(t.dom).find(".fb-canvas-block").css("display", "block"))
                    }),
                $(this.dom)
                    .find(".fb-type-selected")
                    .on("click", function () {
                        "block" == $(t.dom)
                            .find(".fb-type-container")
                            .css("display")
                            ? $(t.dom)
                                .find(".fb-type-container")
                                .hide()
                ...
                $(this.dom)
                    ...
                    .on("click", function (e) {
                        ...
                        $(t.dom)
                            .find(".fb-type-selected")
                            .html($(e.currentTarget).text() + "<div class='fb-select-icon'></div>"),
                        $(t.dom)
                            .find(".fb-select-value")
            ...
            this.post = function () {
                ...
                bds.se.ShortCut.uploadImg
                    ? $
                        .post(bds.se.ShortCut.domain, data)
                        .success(function (t) {
                            "Success" == jQuery
                                .parseJSON(t)
                                .status || alert(decodeURIComponent(jQuery.parseJSON(t).errors))
                        })
                        .error(function () {
                            alert("fail")
                        })
                    : $
                        .ajax({url: bds.se.ShortCut.domain, dataType: "jsonp", data: data, jsonp: "cb1"})
                        .success(function (t) {
        ...
        function c(t, e) {
            ...
            this.build = function () {
                var t = "",
                    e = '<div class="fb-textarea fb-content-block"><textarea maxlength="400" class ="fb-d' +
                            'es-content" name="content" placeholder="请详细说明，以便于我们定位和解决问题，如：内容有误/定位地点不准确等（字数限制在' +
                            '300字以内）"></textarea></div>',
                    n = '<div class="fb-block fb-email-block"><input type="text" class="fb-email" maxleng' +
                            'th="100" name="email" placeholder="联系邮箱（留下联系邮箱，以便我们快速反馈）"></div>';
                t = '<div class="fb-modal" ><div class="fb-header" id="fb_dialog_header" unselectable' +
                        '="on" onselectstart="return false;"><a class="fb-close" id="fb_close_x">×</a><h3' +
                        '  class="fb-header-tips">单条结果反馈</h3></div><div class="fb-body" id="fb_qa_feedbac' +
                        'k_body"><div class="fb-action"><form id="fb_right_post_form" enctype="multipart/' +
                        'form-data" method="post" onsubmit = "return false;">' + this.content_tips_div + e + n + '</form> </div><div class="fb-hint fb-hint-no-content"><span>请填写描述反馈</span></div>' +
                        '<div class="fb-hint fb-hint-no-email"><span>请留下您的联系方式</span></div><div class="fb' +
                        '-hint fb-hint-error-email"><span>邮箱格式不正确</span></div><div class="fb-footer"><div' +
                        ' class="fb-btn fb-btn-primary" id="fb_list_post_save">提交反馈</div></div><div class' +
                        '="fb-guide fb-guide-block"><span><a style="text-decoration:underline;" href="htt' +
                        'p://ufo.baidu.com/listen/history?type=commonqa#/commonqa" target="_blank">常见解决办法' +
                        '</a></span><span><a style="text-decoration:underline;float:right;margin-right: -' +
                        '5px;" href="http://ufo.baidu.com/listen/history?type=history#/history" target="_' +
                        'blank">我的反馈</a></span></div></div></div><div class="fb-success" style="display:n' +
                        'one" ><div class="fb-header" id="fb_dialog_header" unselectable="on" onselectsta' +
                        'rt="return false;"><a class="fb-close" id="fb_close_x">×</a><h3  class="fb-heade' +
                        'r-tips">非常感谢</h3></div><div class="fb-body" id="fb_qa_feedback_body"><div class=' +
                        '"fb-success-text fb-success-text-title"><i class="c-icon c-icon-right-empty"></i' +
                        '>提交成功</div><div class="fb-success-text">感谢您的宝贵意见</div></div></div>';
            ...
            this.bindEvent = function () {
                ...
                $(this.dom)
                    .find("#fb_list_post_save")
                    .on("click", function () {
                        $(t.dom)
                            .find(".fb-textarea textarea")
                            .val()
                            ? -1 == [27468, 27463].indexOf(Number($(t.dom).find(".fb-select-value").val())) || $(t.dom)
                                .find(".fb-email")
                                .val()
                                ? $(t.dom)
                                    .find(".fb-email")
            ...
            this.post = function () {
                ...
                bds
                    .se
                    .ShortCut
                    .get_Snapshot_list(-bds.se.ShortCut.curListDom.offset().left, -bds.se.ShortCut.curListDom.offset().top, bds.se.ShortCut.curListDom.width() + 20, bds.se.ShortCut.curListDom.height() + 12, function () {
                        data = {
                            product_type: 26138,
                            content: t.content,
                            type: t.type,
        ...
        bds && bds.se && (bds.se.ShortCut = {
            ...
            domain: bds
                .util
                .domain
                .get("api.open.baidu.com") + "/pae/common/api/feedback",
            img_base64: "",
            img_base64_list: "",
            initRightBar: function () {
                this.html2canvas(),
                this._getCss(),
                this._identifyCanvas() && this._identifyCors()
                    ? (bds.se.ShortCut.uploadImg = !0, this.get_Snapshot())
                    : bds.se.ShortCut.uploadImg = !1
            },
            _getCss: function () {
                bds
                    .util
                    .addStyle("#content_left > div,#rs,#con-ar .result-op{position: relative;}")
            },
            ...
            init_ala: function (t) {
                this.html2canvas(),
                bds.se.ShortCut.uploadImg = this._identifyCanvas() && this._identifyCors()
                    ? !0
                    : !1,
                ...
                t
                    .find(".fb-list-container")
                    .css("width", t.width() + 20),
                t
                    .find(".fb-list-container")
                    .css("height", t.height() + 10),
            ...
            init_shade: function () {
                ...
                $(".fb-list-container").hover(function (t) {
                    ...
                    $(t.currentTarget)
                        .children()
                        .length || e($(t.currentTarget))
                }, function (e) {
                    t($(e.currentTarget)) != bds.se.ShortCut.key && n($(e.currentTarget))
                }),
                $(".fb-list-container").on("click", function (o) {
                    $(".c-container")
                        .first()
                        .children(".fb-hint-tip")
                        .remove(),
                    ...
                    bds.se.ShortCut.ldialog && bds
                        ...
                        .destory(),
                    n($(".fb-list-container")),
                    t($(o.currentTarget)) == bds.se.ShortCut.key
                        ? (bds.se.ShortCut.key = 0, bds.se.ShortCut.rdialog && bds.se.ShortCut.rdialog.grayed(0))
                        : (bds.se.ShortCut.key = t($(o.currentTarget)), bds.se.ShortCut.curListDom = $(o.currentTarget), bds.se.ShortCut.ldialog = new c(i($(o.currentTarget))), bds.se.ShortCut.rdialog && bds.se.ShortCut.rdialog.grayed(1), e($(o.currentTarget)))
                }),
                $(".fb-mask").on("click", function () {
                    bds.se.ShortCut.ldialog && bds
                        .se
            ...
            get_Snapshot: function () {
                ...
                html2canvas(document.body, {
                    proxy: bds
                        .util
                        .domain
                        .get("f3.baidu.com") + "/getProxyImage.php",
            ...
            html2canvas: function () {
                !function (t, e, n) {
                    "use strict";
                    function o(e) {
                        d.logging && t.console && t.console.log && t
                            .console
                            .log(e)
                    }
                    function i(t, e, n, o, i, r) {
                        var s,
                            ...
                            u = d
                                .Util
                                .getCSS(e, t, i);
                        if (1 === u.length && (l = u[0], u = [], u[0] = l, u[1] = l), -1 !== u[0].toString().indexOf("%")) 
                            c = parseFloat(u[0]) / 100,
                            a = n.width * c,
                            ...
                            if ("auto" === u[0]) 
                                ...
                                var m = d
                                    .Util
                                    .resizeBounds(o.width, o.height, n.width, n.height, u[0]);
                                a = m.width,
                                s = m.height
                            } else 
                                a = parseInt(u[0], 10);
                        ...
                        return "auto" === u[1]
                            ...
                            : -1 !== u[1]
                                .toString()
                                .indexOf("%")
                                ? (c = parseFloat(u[1]) / 100, s = n.height * c, "backgroundSize" !== t && (s -= (r || o).height * c))
                                : s = parseInt(u[1], 10),
                        [a, s]
                    }
                    function r(t, e) {
                        ...
                        return {
                            ...
                            height: e,
                            clip: function () {
                                n.push({type: "function", name: "clip", arguments: arguments})
                            },
                            translate: function () {
                                n.push({type: "function", name: "translate", arguments: arguments})
                            },
                            fill: function () {
                                n.push({type: "function", name: "fill", arguments: arguments})
                            },
                            save: function () {
                                n.push({type: "function", name: "save", arguments: arguments})
                            },
                            restore: function () {
                                n.push({type: "function", name: "restore", arguments: arguments})
                            },
                            fillRect: function () {
                                n.push({type: "function", name: "fillRect", arguments: arguments})
                            },
                            createPattern: function () {
                                n.push({type: "function", name: "createPattern", arguments: arguments})
                            },
                            drawShape: function () {
                                var t = [];
                                return n.push({type: "function", name: "drawShape", arguments: t}), {
                                    moveTo: function () {
                            ...
                            drawImage: function () {
                                n.push({type: "function", name: "drawImage", arguments: arguments})
                            },
                            fillText: function () {
                                n.push({type: "function", name: "fillText", arguments: arguments})
                            },
                            setVariable: function (t, e) {
                                n.push({type: "variable", name: t, arguments: e})
                            }
                        }
                    }
                    function s(t) {
                    ...
                    d.Util.Bounds = function (t) {
                        ...
                        return t.getBoundingClientRect
                            ? (e = t.getBoundingClientRect(), n.top = e.top, n.bottom = e.bottom || e.top + e.height, n.left = e.left, n.width = e.width || e.right - e.left, n.height = e.height || e.bottom - e.top, n)
                            : void 0
                    },
                    d.Util.getCSS = function (t, o, i) {
                        function r(e, n) {
                            var o,
                                i = t.runtimeStyle && t.runtimeStyle[e],
                                r = t.style;
                            return !/^-?[0-9]+\.?[0-9]*(?:px)?$/i.test(n) && /^-?\d/.test(n) && (o = r.left, i && (t.runtimeStyle.left = t.currentStyle.left), r.left = "fontSize" === e
                                ? "1em"
                                : n || 0, n = r.pixelLeft + "px", r.left = o, i && (t.runtimeStyle.left = i)),
                            /^(thin|medium|thick)$/i.test(n)
                                ? n
                                : Math.round(parseFloat(n)) + "px"
                        }
                        var s,
                            l = o.match(/^background(Size|Position)$/);
                                ...
                                switch (r[1]) {
                                    ...
                                    case "-o-linear-gradient":
                                        if (o = {
                                            ...
                                            for (c = a.length, d = 1 / Math.max(c - 1, 1), i = 0; c > i; i += 1) 
                                                l = a[i].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/),
                                                l[2]
                                                    ? (s = parseFloat(l[2]), s /= "%" === l[3]
                                                        ? 100
                                                        : n.width)
                                                    : s = i * d,
                                                o.colorStops.push({color: l[1], stop: s});
                                    break;
                                    case "-webkit-gradient":
                                        if (o = {
                                            ...
                                            for (c = a.length, i = 0; c > i; i += 1) 
                                                l = a[i].match(/(from|to|color-stop)\(([0-9\.]+)?(?:,\s)?((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\)/),
                                                s = parseFloat(l[2]),
                                                "from" === l[1] && (s = 0),
                                                "to" === l[1] && (s = 1),
                                                o.colorStops.push({color: l[3], stop: s});
                                    break;
                                    case "-moz-linear-gradient":
                                        if (o = {
                                            ...
                                            for (c = a.length, d = 1 / Math.max(c - 1, 1), i = 0; c > i; i += 1) 
                                                l = a[i].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%)?/),
                                                l[2]
                                                    ? (s = parseFloat(l[2]), l[3] && (s /= 100))
                                                    : s = i * d,
                                                o.colorStops.push({color: l[1], stop: s});
                                    break;
                                    ...
                                    case "-o-radial-gradient":
                                        if (o = {
                                            ...
                                            ry: 0,
                                            colorStops: []
                                        }, a = r[2].match(/(\d{1,3})%?\s(\d{1,3})%?/), a && (o.cx = a[1] * n.width / 100, o.cy = a[2] * n.height / 100), a = r[3].match(/\w+/), l = r[4].match(/[a-z\-]*/), a && l) 
                                            switch (l[0]) {
                                                ...
                                                case "farthest-side":
                                                    "circle" === a[0]
                                                        ? o.rx = o.ry = Math.max(o.cx, o.cy, o.x1 - o.cx, o.y1 - o.cy)
                                                        : (o.type = a[0], o.rx = Math.max(o.cx, o.x1 - o.cx), o.ry = Math.max(o.cy, o.y1 - o.cy));
                                                    break;
                                                case "closest-side":
                                                case "contain":
                                                    "circle" === a[0]
                                                        ? o.rx = o.ry = Math.min(o.cx, o.cy, o.x1 - o.cx, o.y1 - o.cy)
                                                        : (o.type = a[0], o.rx = Math.min(o.cx, o.x1 - o.cx), o.ry = Math.min(o.cy, o.y1 - o.cy))
                                            }
                        ...
                        d.Generate.Gradient = function (t, n) {
                            if (0 !== n.width && 0 !== n.height) {
                                ...
                                if (c.width = n.width, c.height = n.height, i = d.Generate.parseGradient(t, n)) 
                                    if ("linear" === i.type) {
                                        for (r = l.createLinearGradient(i.x0, i.y0, i.x1, i.y1), s = 0, a = i.colorStops.length; a > s; s += 1) 
                                            try {
                                    ...
                                    for (r = l.createRadialGradient(i.cx, i.cy, 0, i.cx, i.cy, i.rx), s = 0, a = i.colorStops.length; a > s; s += 1) 
                                        try {
                                            r.addColorStop(i.colorStops[s].stop, i.colorStops[s].color)
                                        } catch (u) {
                                            o([
                                    ...
                                    var m = e.createElement("canvas"),
                                        ...
                                        h = 2 * f;
                                    for (m.width = m.height = h, r = p.createRadialGradient(i.rx, i.ry, 0, i.rx, i.ry, f), s = 0, a = i.colorStops.length; a > s; s += 1) 
                                        try {
                                            r.addColorStop(i.colorStops[s].stop, i.colorStops[s].color)
                                        } catch (u) {
                                            o([
                    ...
                    d.Parse = function (i, a) {
                        ...
                        function h(t, e, n, o) {
                            null !== t && d
                                .Util
                                .trimText(t)
                                .length > 0 && (o.fillText(t, e, n), se += 1)
                        }
                        function g(t, e, n, o) {
                            var i = !1,
                                r = ue(e, "fontWeight"),
                        ...
                        function v(t, e, n, o) {
                            var i;
                            if (ce.rangeBounds) 
                                ("none" !== n || 0 !== d.Util.trimText(e).length) && (i = w(e, t.node, t.textOffset)),
                        ...
                        function y(t, e, n) {
                            ...
                            d
                                .Util
                                .trimText(e.nodeValue)
                                .length > 0 && (e.nodeValue = p(e.nodeValue, ue(t, "textTransform")), l = l.replace(["-webkit-auto"], ["auto"]), i = e.nodeValue.split(!a.letterRendering && /^(left|right|justify|auto)$/.test(l) && f(ue(t, "letterSpacing"))
                                ? /(\b| )/
                                : ""), o = g(r, t, c, s), a.chinese && i.forEach(function (t, e) {
                        ...
                        function x(t, e) {
                            var n,
                                o,
                                i = ae.createElement("boundelement");
                        ...
                        function k(t, e, n) {
                            ...
                            if (/^(decimal|decimal-leading-zero|upper-alpha|upper-latin|upper-roman|lower-alpha|lower-greek|lower-latin|lower-roman)$/i.test(a)) {
                                if (i = T(t, a), r = x(t, i), g(s, t, "none", ue(t, "color")), "inside" !== ue(t, "listStylePosition")) 
                                    return;
                        ...
                        function j(t, e, n, o, i, r, s) {
                            e[0] > 0 || e[1] > 0
                                ? (t.push(["line", o[0].start.x, o[0].start.y]), o[0].curveTo(t), o[1].curveTo(t))
                                : t.push(["line", r, s]),
                        ...
                        function q(t, e, n, o, i, r, s) {
                            var a = [];
                            return e[0] > 0 || e[1] > 0
                                ? (a.push(["line", o[1].start.x, o[1].start.y]), o[1].curveTo(a))
                                : a.push(["line", t.c1[0], t.c1[1]]),
                            n[0] > 0 || n[1] > 0
                                ? (a.push(["line", r[0].start.x, r[0].start.y]), r[0].curveTo(a), a.push(["line", s[0].end.x, s[0].end.y]), s[0].curveToReversed(a))
                        ...
                        function U(t, e, n) {
                            var o = t.left,
                                ...
                                v = s - f;
                            return {
                                topLeftOuter: fe(o, i, a, c)
                                    .topLeft
                                    .subdivide(.5),
                                topLeftInner: fe(o + n[3].width, i + n[0].width, Math.max(0, a - n[3].width), Math.max(0, c - n[0].width))
                                    .topLeft
                                    .subdivide(.5),
                                topRightOuter: fe(o + h, i, d, l)
                                    .topRight
                                    .subdivide(.5),
                                topRightInner: fe(o + Math.min(h, r + n[3].width), i + n[0].width, h > r + n[3].width
                                        ? 0
                                        : d - n[3].width, l - n[0].width)
                                    .topRight
                                    .subdivide(.5),
                                bottomRightOuter: fe(o + b, i + g, m, u)
                                    .bottomRight
                                    .subdivide(.5),
                                bottomRightInner: fe(o + Math.min(b, r + n[3].width), i + Math.min(g, s + n[0].width), Math.max(0, m - n[1].width), Math.max(0, u - n[2].width))
                                    .bottomRight
                                    .subdivide(.5),
                                bottomLeftOuter: fe(o, i + v, p, f)
                                    .bottomLeft
                                    .subdivide(.5),
                                bottomLeftInner: fe(o + n[3].width, i + v, Math.max(0, p - n[3].width), Math.max(0, f - n[2].width))
                                    .bottomLeft
                                    .subdivide(.5)
                            }
                        }
                        ...
                        function P(t, e, n) {
                            ...
                            i = "SELECT" === t.nodeName
                                ? (t.options[t.selectedIndex] || 0).text
                                : t.value,
                            i || (i = t.placeholder),
                        ...
                        function z(t) {
                            t
                                .drawImage
                                .apply(t, Array.prototype.slice.call(arguments, 1)),
                            se += 1
                        }
                        function B(n, i) {
                        ...
                        function V(t, e, n, o, i) {
                            var r = d
                                    .Util
                                    .BackgroundSize(t, e, o, i),
                                s = d
                                    .Util
                                    .BackgroundPosition(t, e, o, i, r),
                                a = ue(t, "backgroundRepeat")
                                    .split(",")
                                    .map(function (t) {
                                        return t.trim()
                                    });
                        ...
                        function X(t, e, n) {
                            for (var i, r = ue(t, "backgroundImage"), s = d.Util.parseBackgroundImage(r), a = s.length; a--;) 
                                if (r = s[a], r.args && 0 !== r.args.length) {
                                    ...
                                    i
                                        ? V(t, e, n, i, a)
                                        : o("html2canvas: Error loading background:", r)
                                }
                            }
                        function J(t, e) {
                        ...
                        function Y(t, e, n) {
                            ...
                            return a.useOverflow === !0 && /(hidden|scroll|auto)/.test(ue(t, "overflow")) === !0 && /(BODY)/i.test(t.nodeName) === !1 && (i.clip = i.clip
                                ? S(i.clip, n)
                                : n),
                            i
                                .zIndex
                        ...
                        function te(t, e, n) {
                            var i,
                                r = d
                                    .Util
                                    .Bounds(t),
                                s = de.test(t.nodeName)
                                    ? "#efefef"
                                    : ue(t, "backgroundColor"),
                                a = Y(t, e, r),
                                c = a.borders,
                                l = a.ctx,
                                u = Z(c, r, a.clip),
                            ...
                            switch (N(l, m.clip), l.save(), l.clip(), u.height > 0 && u.width > 0 && (Q(l, r, s), X(t, u, l)), l.restore(), m.borders.forEach(function (t) {
                                ...
                                case "IMG":
                                    (i = C(t.getAttribute("src")))
                                        ? D(l, t, i, r, c)
                                        : o("html2canvas: Error loading <img>:" + t.getAttribute("src"));
                                    break;
                                case "INPUT":
                        ...
                        function oe(t, e) {
                            function n(t) {
                                var e,
                                    ...
                                    l = c.length;
                                for (a = 0; l > a; a += 1) 
                                    if (r = c[a], 3 === r.nodeType) 
                                        s += r.nodeValue.replace(/</g, "&lt;").replace(/>/g, "&gt;");
                                    else if (1 === r.nodeType && !/^(script|meta|title)$/.test(r.nodeName.toLowerCase())) {
                                        if (s += "<" + r.nodeName.toLowerCase(), r.hasAttributes()) 
                                            for (e = r.attributes, i = e.length, o = 0; i > o; o += 1) 
                                                s += " " + e[o].name + '="' + e[o].value + '"';
                                    s += ">",
                                        n(r),
                                        s += "</" + r
                                            .nodeName
                            ...
                            n(t),
                            o.src = [
                                "data:image/svg+xml,", "<svg xmlns='http://www.w3.org/2000/svg' version='1.1' width='" + i + "' height='" + r + "'>",
                    ...
                    d.Preload = function (i) {
                        ...
                        function a(e, o, r) {
                            ...
                            t[a] = function (e) {
                                "error:" === e.substring(0, 6)
                                    ? (r.succeeded = !1, _.numLoaded++, _.numFailed++, s())
                                    : (h(o, r), o.src = e),
                                t[a] = n;
                                try {
                                    delete t[a]
                        ...
                        function p(t, e) {
                            ...
                            d
                                .Util
                                .parseBackgroundImage(t)
                                .filter(m)
                                .forEach(function (t) {
                                    "url" === t.method
                                        ? b.loadImage(t.args[0])
                                        : t
                                            .method
                                            .match(/\-?gradient$/) && (o === n && (o = d.Util.Bounds(e)), u(t.value, o))
                                })
                        }
                        function f(t) {
                            var e = !1;
                        ...
                        for (C.href = t.location.href, g = C.protocol + C.host, b = {
                            loadImage: function (e) {
                                var o,
                                    s;
                                e && _[e] === n && (o = new Image, e.match(/data:image\/.*;base64,/i)
                                    ? (o.src = e.replace(/url\(['"]{0,}|['"]{0,}\)$/gi, ""), s = _[e] = {
                                        img: o
                                    }, _.numTotal++, h(o, s))
                                    : r(e) || i.allowTaint === !0
                                        ? (s = _[e] = {
                                            img: o
                                        }, _.numTotal++, h(o, s), o.src = e)
                                        : S && !i.allowTaint && i.useCORS
                                            ? (o.crossOrigin = "anonymous", s = _[e] = {
                                                img: o
                                                ...
                                                this.img.complete
                                                    ? this
                                                        .img
                                                        .onerror()
                                                    : this.timer = t.setTimeout(this.img.customComplete, 100)
                                            }.bind(s),
                                            o.customComplete())
                                            : i.proxy && (s = _[e] = {
                                                img: o
                            ...
                            cleanupDOM: function (r) {
                                ...
                                if (!_.cleanupDone) {
                                    o(r && "string" == typeof r
                                        ? "html2canvas: Cleanup because: " + r
                                        : "html2canvas: Cleanup after timeout: " + i.timeout + " ms.");
                                    for (c in _) 
                                    ...
                                    t.stop !== n
                                        ? t.stop()
                                        : e.execCommand !== n && e.execCommand("Stop", !1),
                                    e.close !== n && e.close(),
                                    _.cleanupDone = !0,
                                    r && "string" == typeof r || s()
                                }
                        ...
                        }, i.timeout > 0 && (w = t.setTimeout(b.cleanupDOM, i.timeout)), o("html2canvas: Preload starts: finding background-images"), _.firstRun = !0, f(x), o("html2canvas: Preload: Finding images"), v = 0; k > v; v += 1) 
                            b.loadImage(T[v].getAttribute("src"));
                        return _.firstRun = !1,
                    ...
                    d.Renderer = function (t, o) {
                        ...
                        function r(t) {
                            var e;
                            if ("string" == typeof o.renderer && d.Renderer[t] !== n) 
                                e = d.Renderer[t](o);
                            else {
                    ...
                    d.Renderer.Canvas = function (t) {
                                ...
                                case "function":
                                    if ("createPattern" === n.name) {
                                        ...
                                        "drawShape" === n.name
                                            ? i(e, n.arguments)
                                            : "drawImage" === n.name
                                                ? n.arguments[8] > 0 && n.arguments[7] > 0 && (!t.taintTest || t.taintTest && r(n)) && e
                                                    .drawImage
                                                    .apply(e, n.arguments)
                        ...
                        return function (t, e, i, r, c) {
                            var d,
                                ...
                                h,
                                g = m.getContext("2d");
                            if (m.width = m.style.width = e.width || t.ctx.width, m.height = m.style.height = e.height || t.ctx.height, h = g.fillStyle, g.fillStyle = s(t.backgroundColor) && e.background !== n
                                ? e.background
                                : t.backgroundColor, g.fillRect(0, 0, m.width, m.height), g.fillStyle = h, e.svgRendering && t.svgRender !== n) 
                                g.drawImage(t.svgRender, 0, 0);
                            else 
                                for (l = 0, u = r.length; u > l; l += 1) 
                                    d = r.splice(0, 1)[0],
                            ...
                            d.ctx.storage && d
                                .ctx
                                .storage
                                .forEach(a.bind(null, g)),
                            d.clip && g.restore();
                            return o("html2canvas: Renderer: Canvas renderer done - returning canvas obj"),
                            u = e.elements.length,
                            1 === u && "object" == typeof e.elements[0] && "BODY" !== e.elements[0].nodeName
                                ? (f = c.Util.Bounds(e.elements[0]), p = i.createElement("canvas"), p.width = f.width, p.height = f.height, g = p.getContext("2d"), g.drawImage(m, f.left, f.top, f.width, f.height, 0, 0, f.width, f.height), m = null, p)
                                : m
                        }
                    }
                }(window, document)
    ...
    !function () {
        function t(t) {
            var e = ["voice_beha=1"],
                n = window.bds && bds.util && bds.util.domain
                    ? bds
                        .util
                        .domain
                        .get("http://nsclick.baidu.com")
                    : "http://nsclick.baidu.com";
            for (var o in t) 
                t.hasOwnProperty(o) && e.push(o + "=" + t[o]);
            var i = window["nsIMG" + + new Date] = new Image;
            return i.src = n + "/v.gif?pid=201&" + e.join("&"),
            !0
        }(location.href.match(/voice=1/) || navigator.userAgent.match(/mac os x/i)) && require([
            "plugins/swfobject", "voice/js/voice"
        ], function (e, n) {
                ...
                o.click(function () {
                    var t = n.init({
                        url: bds
                            .util
                            .domain
                            .get("http://vse.baidu.com") + "/echo.fcgi"
                    });
                    t.done(function (t) {
                        t.openUI(),
