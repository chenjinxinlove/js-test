...
Halftone.prototype.render = function() {
  ...
  this.ctx.fillStyle = this.options.isAdditive ? 'rgba(0,179,160,.5)' : 'rgba(38,42,47,.7)';
...
var channelFillStyles = {
  additive: {
    red: 'rgba(0,179,160,.5)',
    green: 'rgba(255,243,229,.1)',
    blue: 'rgba(38,42,47,.7)',
    lum: '#FFF'
  },
  subtractive: {
    red: 'rgba(0,179,160,.9)',
    green: 'rgba(255,243,229,.6)',
    blue: 'rgba(38,42,47,.3)',
    lum: '#000'
  }
};
...
Halftone.prototype.renderGrid = function( channel ) {
  ...
  // clear
  proxy.ctx.fillStyle = this.options.isAdditive ? 'rgba(0,179,160,.1)' : 'rgba(0,179,160,.1)';
